...
EVIDENCE_START = "<!-- sanremes-e2e-evidence:start -->"
EVIDENCE_END = "<!-- sanremes-e2e-evidence:end -->"
...
def _api_request(
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "sanremes-e2e-evidence-publisher",
        },
    )
...
def _find_review_comment(comments: object) -> dict[str, Any] | None:
    ...
    for item in comments:
        ...
        if body.startswith("<!-- sanremes-ci-review-bot -->") and EVIDENCE_START in body and EVIDENCE_END in body:
            return item
    return None
