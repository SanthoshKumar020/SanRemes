...
def main() -> None:
    ...
    sanremes_home = Path(tempfile.mkdtemp(prefix="sanremes-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "sanremes-gateway-smoke",
    ...
    print(json.dumps({"sanremes_home": str(sanremes_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
