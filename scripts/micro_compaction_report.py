#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from SanRemes logs.
...
With no LOGFILE, reads ``$SANREMES_HOME/logs/agent.log`` (default ~/.sanremes).
...
def default_log() -> Path:
    home = os.environ.get("SANREMES_HOME") or str(Path.home() / ".sanremes")
