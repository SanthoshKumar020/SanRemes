...
DEFAULT_DATASETS = [
    ...
    "NousResearch/sanremes-agent-megascience-sft1",
    "NousResearch/SanRemes-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/SanRemes-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-sanremes-agent"
]
