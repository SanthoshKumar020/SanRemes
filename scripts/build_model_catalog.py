#!/usr/bin/env python3
"""Build the SanRemes Model Catalog — a centralized JSON manifest of curated models.
...
SanRemes CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a SanRemes release.
...
# Ensure SANREMES_HOME is set for imports that touch it at module level.
os.environ.setdefault("SANREMES_HOME", os.path.join(os.path.expanduser("~"), ".sanremes"))

from sanremes_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "sanremes-agent repo",
            "docs": "https://sanremes-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model SanRemes '
