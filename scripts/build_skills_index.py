#!/usr/bin/env python3
"""Build the SanRemes Skills Index — a centralized JSON catalog of all skills.
...
`sanremes skills search/install` can use it without hitting the GitHub API.
...
# Ensure SANREMES_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building SanRemes Skills Index...", flush=True)
