...
request omits ``thinking``.  SanRemes' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the SanRemes reasoning
...
(per Z.AI / BigModel docs).  SanRemes' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map SanRemes reasoning effort onto GLM's native vocabulary.
