...
# When the user hasn't picked a reasoning effort, SanRemes passes
...
# ON at this effort — matching the "medium (default)" that SanRemes' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map SanRemes' effort vocabulary onto Solar's accepted set via the
