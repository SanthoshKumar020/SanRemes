...
the contract that subsequent turns echo it back; combined with how SanRemes
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; SanRemes remaps
the retired IDs in ``sanremes_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave SanRemes, so they are not listed here.
    """
