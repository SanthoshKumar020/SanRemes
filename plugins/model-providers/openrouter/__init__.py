...
class OpenRouterProfile(ProviderProfile):
    ...
    def fetch_models(
        ...
        *,
        ...
        Note: Tool-call capability filtering is applied by sanremes_cli/models.py
    ...
    def build_api_kwargs_extras(
        ...
        **context: Any,
        ...
        if supports_reasoning:
            ...
            # model default to adaptive. See sanremes-agent#42991 (disable case)
            ...
            # live token-spend probe in sanremes-agent#43432). Route the existing
