...
Single-user SanRemes memory store plugin.
"""
...
class MemoryStore:
    ...
    def __init__(
        ...
        if db_path is None:
            ...
            db_path = str(get_sanremes_home() / "memory_store.db")
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted SANREMES_HOME (same issue as
        # state.db / kanban.db — see sanremes_state._WAL_INCOMPAT_MARKERS).
