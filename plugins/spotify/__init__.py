...
``_check_spotify_available()`` — when the user has not run ``sanremes auth
spotify``, the tools remain registered (so they appear in ``sanremes
...
The Spotify auth flow (``sanremes auth spotify``), CLI plumbing, and docs
