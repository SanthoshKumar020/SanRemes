...
// `message.content.text` before SanRemes can see it. We rewrite the two inbound
...
const MARKER = "SanRemes patch: Preserve mixed text + attachment iMessage payloads";
