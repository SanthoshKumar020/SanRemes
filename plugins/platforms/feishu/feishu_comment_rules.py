...
Config: ~/.sanremes/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.sanremes/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_sanremes_home()`` helper (SANREMES_HOME-aware and
...
RULES_FILE = get_sanremes_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_sanremes_home() / "feishu_comment_pairing.json"
