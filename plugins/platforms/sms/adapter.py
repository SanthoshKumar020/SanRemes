...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> SanRemes gateway adapter.

    Each inbound phone number gets its own SanRemes session (multi-tenant).
...
# static dict in sanremes_cli/gateway.py, and the _send_sms dispatch in
