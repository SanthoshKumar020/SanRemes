...
required — uses aiohttp which is already a SanRemes dependency.
...
def interactive_setup() -> None:
    ...
    ``sanremes_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where SanRemes delivers cron job results and notifications.")
    ...
    print_info("   Open config in your editor:  sanremes config edit")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # sanremes_cli/setup.py::_setup_mattermost function.
