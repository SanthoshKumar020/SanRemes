"""
A2A (Agent-to-Agent) plugin for SanRemes Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes SanRemes as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    """`sanremes gateway setup` flow for A2A."""
    ...
    print_info("Expose SanRemes as an A2A-discoverable agent and call other A2A agents.")
