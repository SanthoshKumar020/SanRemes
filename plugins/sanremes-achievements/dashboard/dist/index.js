(function () {
  "use strict";
  // sanremes-achievements dashboard plugin
  // Originally authored by @PCinkusz — https://github.com/PCinkusz/sanremes-achievements (MIT).
  // Bundled into sanremes-agent. Upstream repo remains the staging ground for new
  ...
  if (!SDK || !window.__SANREMES_PLUGINS__) return;
  ...
  function api(path, options) {
    ...
    // BOTH dashboard modes: loopback (X-SanRemes-Session-Token header) and
    // gated OAuth (sanremes_session_at cookie via credentials:'include').
    // Hand-rolling fetch + reading window.__SANREMES_SESSION_TOKEN__ directly
    ...
    const url = "/api/plugins/sanremes-achievements" + path;
  ...
  async function buildShareImage(achievement) {
    ...
    ctx.fillText("SANREMES AGENT  ·  sanremes-agent.nousresearch.com", 70, H - 40);
  ...
  function ShareDialog({ achievement, onClose }) {
    ...
    function download() {
      ...
      a.href = url;
      a.download = "sanremes-achievement-" + (achievement.id || "badge") + ".png";
    ...
    function tweetText() {
      ...
      const tmpl = tx(t, "share.tweet_text", "Just unlocked {tier_part}\"{name}\" in SanRemes Agent ☤", {
        tier_part: tierPart,
        name: achievement.name,
      });
      return tmpl + "\n\n@NousResearch · https://sanremes-agent.nousresearch.com";
    }
    ...
    return React.createElement("div", { className: "ha-page ha-page-loading" },
      React.createElement("section", { className: "ha-hero ha-loading-hero" },
        React.createElement("div", null,
          ...
          React.createElement("h1", null, tx(t, "hero.title", "SanRemes Achievements")),
          React.createElement("p", null, tx(t, "hero.scan_subtitle", "Scanning SanRemes session history. First scan can take 5–10 seconds on large histories."))
        ),
      ...
      React.createElement("section", { className: "ha-guide ha-loading-guide" },
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.scan_status_body", "SanRemes is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds."))
        ),
        React.createElement("div", null,
    ...
    return React.createElement("div", { className: "ha-page" },
      React.createElement("section", { className: "ha-hero" },
        React.createElement("div", null,
          React.createElement("div", { className: "ha-kicker" }, tx(t, "hero.kicker", "Agentic Gamerscore")),
          React.createElement("h1", null, tx(t, "hero.title", "SanRemes Achievements")),
          React.createElement("p", null, tx(t, "hero.subtitle", "Collectible SanRemes badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears."))
        ),
      ...
      React.createElement("div", { className: "ha-stats" },
        ...
        React.createElement(StatCard, { label: tx(t, "stats.latest", "Latest"), value: latest[0] ? latest[0].name : tx(t, "stats.none_yet", "None yet"), hint: latest[0] ? latest[0].category : tx(t, "stats.latest_hint_empty", "run SanRemes more") })
      ),
      React.createElement("section", { className: "ha-guide" },
        ...
        React.createElement("div", null,
          ...
          React.createElement("p", null, tx(t, "guide.secret_body", "Secrets hide their exact trigger. Once SanRemes sees a related signal, the card becomes Discovered and shows its requirement."))
        )
      ),
  ...
  window.__SANREMES_PLUGINS__.register("sanremes-achievements", AchievementsPage);
})();
