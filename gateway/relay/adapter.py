...
class RelayAdapter(BasePlatformAdapter):
    ...
    def _relay_slack_extra(self) -> Dict[str, Any]:
        ...
        Enterprise knob shape (SanRemes-config directed, relay-namespaced):
    ...
    def _slack_unfurl_hints(self, platform: Optional[str]) -> Optional[Dict[str, bool]]:
        ...
        for knob in ("unfurl_links", "unfurl_media"):
            ...
            if val is None:
                continue
            # Railway / `sanremes config set` write YAML strings ("true"/"false").
        ...
        try:
            ...
            if platform == "discord":
                ...
                if event is not None:
                    self._capture_scope(event)
                    # Phase 3: a component press carrying a SanRemes prompt token
    ...
    def _discord_interaction_to_event(self, forward):
        ...
        if itype == 3:
            # Phase 3: a component press whose custom_id is a SanRemes prompt
    ...
    def _decode_prompt_token(token: str):
        ...
        — and is not — a SanRemes prompt answer.
        """
        import re
    ...
    def _resolve_reply_to_for_send(
        ...
        Native Slack SanRemes already suppresses this synthetic DM thread anchor:
    ...
    async def _send_prompt(
        ...
        *,
        ...
        # SanRemes suppresses this synthetic DM thread anchor; drop it here for the
