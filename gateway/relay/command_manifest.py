...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your SanRemes session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show SanRemes session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running SanRemes agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update SanRemes Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the SanRemes gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a SanRemes session in it",
