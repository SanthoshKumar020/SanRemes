...
from environment variables:
  ...
  - ``SANREMES_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SANREMES_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SANREMES_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``sanremes cron run`` in the CLI, ``sanremes send``, a
...
_STRICT_ENV = "SANREMES_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SANREMES_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SANREMES_MEDIA_TRUST_RECENT_FILES"
