...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SANREMES_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_sanremes_dir("platforms/whatsapp/session", "whatsapp/session")
