...
_APP_VERSION = _SANREMES_VERSION
_BOT_VERSION = _SANREMES_VERSION
_YUANBAO_INSTANCE_ID = str(SANREMES_INSTANCE_ID)  # single source: yuanbao_proto.SANREMES_INSTANCE_ID
        ...
        if not adapter._auto_sethome_done and adapter._sender_may_designate_home(ctx):
            ...
            if _should_set:
                try:
                    ...
                    from sanremes_cli.config import atomic_config_write, read_user_config_raw
