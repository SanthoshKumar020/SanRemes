...
(``~/.sanremes/plans/god-file-decomposition.md``, Phase 3 mechanical mixin lifts).
...
class GatewayAuthorizationMixin:
    ...
    def _adapter_group_has_sender_allowlist(
        ...
        *,
        ...
        restricting which senders inside that group can invoke SanRemes. If such a
    ...
    def _is_user_authorized(
        ...
        *,
        ...
        # (sanremes gateway pairing approve / the authenticated dashboard) — an
