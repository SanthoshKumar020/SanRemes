...
# Set by ``sanremes gateway run --external-supervisor``. Unlike systemd's
...
EXTERNAL_GATEWAY_SUPERVISOR_ENV = "SANREMES_GATEWAY_EXTERNAL_SUPERVISOR"
...
def is_gateway_supervisor_process(
    ...
    if env.get("INVOCATION_ID"):
        return True
    if env.get("SANREMES_S6_SUPERVISED_CHILD"):
        return True
