...
Hooks are discovered from ~/.sanremes/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- SanRemes session id
...
HOOKS_DIR = get_sanremes_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"sanremes_hook_{hook_name}"
