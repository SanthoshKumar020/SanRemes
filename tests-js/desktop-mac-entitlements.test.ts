 ...
 *
 * SanRemes Desktop signs with ``hardenedRuntime: true`` and points
...
test('bootstrap installer carries microphone entitlement for launcher attribution', () => {
  ...
  assert.equal(
    ...
    'the macOS bootstrap installer must sign with its entitlements.plist. ' +
      'When /Applications/SanRemes.app is the setup launcher, macOS TCC treats ' +
      'com.nousresearch.sanremes.setup as the responsible process for the desktop ' +
