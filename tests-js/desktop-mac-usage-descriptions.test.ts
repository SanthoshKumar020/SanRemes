 ...
 *
 * Each entry is a key/value pair that lands in the packaged SanRemes.app's
 ...
 * "SanRemes wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("SanRemes wants to access Music" when SanRemes never touches the Music
