 ...
 * across theme x background scenes to <tmpdir>/sanremes-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@sanremes/ink'
...
// The regenerated slate light_colors block from sanremes_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/sanremes-agent',
...
const setup = (bgHex: string) => {
  process.env.SANREMES_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
