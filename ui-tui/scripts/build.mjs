...
await build({
  ...
  // Skip the prebuilt @sanremes/ink bundle and inline the source instead:
  ...
  alias: { '@sanremes/ink': resolve(root, 'packages/sanremes-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The sanremes_cli launcher
