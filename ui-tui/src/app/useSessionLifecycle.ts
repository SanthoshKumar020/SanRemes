...
import type { ScrollBoxHandle } from '@sanremes/ink'
import { evictInkCaches } from '@sanremes/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SANREMES_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
