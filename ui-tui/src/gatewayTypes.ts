import type { BillingBlock, UsageModelData } from '@sanremes/shared/billing'
import type { SanRemesSkin } from '@sanremes/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@sanremes/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = SanRemesSkin
...
// Wire shapes now live in @sanremes/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
