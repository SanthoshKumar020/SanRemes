...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@sanremes/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/sanremes-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/sanremes-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/sanremes-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/sanremes-ink/src/ink/dom.js'
import Output from '../../packages/sanremes-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/sanremes-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/sanremes-ink/src/ink/root.js'
