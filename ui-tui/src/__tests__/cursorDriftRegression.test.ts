 ...
 *
 * Symptom: in `sanremes --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@sanremes/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using sanremes --tui and as i type multiline my caret at the end will often ' +
