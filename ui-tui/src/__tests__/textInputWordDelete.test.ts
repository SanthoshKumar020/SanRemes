...
import { InputEvent } from '../../packages/sanremes-ink/src/ink/events/input-event.js'
import { INITIAL_STATE, parseMultipleKeypresses } from '../../packages/sanremes-ink/src/ink/parse-keypress.js'
...
// web/src/lib/pty-keyboard-shortcuts.ts). sanremes-ink decodes that bare
