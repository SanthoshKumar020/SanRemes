...
import { Box, type ScrollBoxHandle, stringWidth, Text } from '@sanremes/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SANREMES_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SANREMES_DEV_CREDITS), lowest priority,
