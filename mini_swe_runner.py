#!/usr/bin/env python3
"""
SWE Runner with SanRemes Trajectory Format

A runner that uses SanRemes-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the SanRemes-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses SanRemes-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in SanRemes format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches SanRemes-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using SanRemes-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with SanRemes Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses SanRemes-Agent's built-in execution environments
    and outputs trajectories in SanRemes-Agent format.
    """
    ...
    def _convert_to_sanremes_format(
        self,
        ...
        """
        Convert internal message format to SanRemes trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to SanRemes trajectory format
        trajectory = self._convert_to_sanremes_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with SanRemes trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with SanRemes Trajectory Format")
    print("=" * 60)
