...
# by /etc/cont-init.d/01-sanremes-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs sanremes"
...
echo "[sanremes] WARNING: docker/entrypoint.sh is a deprecated shim under " \
