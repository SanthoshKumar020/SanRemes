...
benchmarked ten harnesses on hostile-file handling — and whose SanRemes column
...
Every task runs the full SanRemes agent (file + terminal + search toolsets)
...
Rules of engagement (from sanremesbench discipline):
