...
The A/B battery behind PR [#81958](https://github.com/NousResearch/sanremes-agent/pull/81958)
...
- **Arms differ only by tree + config.** `base` runs the built-in twelve
  ...
  digest's value). Each cell gets a throwaway `SANREMES_HOME`; web-fetch
