...
The run gets a throwaway SANREMES_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE SANREMES_HOME is redirected to the
