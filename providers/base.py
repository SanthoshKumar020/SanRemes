...
def _profile_user_agent() -> str:
    """Return a ``sanremes-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from sanremes_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"sanremes-cli/{_ver}"
    except Exception:
        return "sanremes-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # sanremes-cli UA so the catalog endpoint is reachable.
