/**
 * Canonical SanRemes skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SANREMES_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`sanremes_cli/skin_engine.py`),
 ...
 *   • CLI     → `sanremes_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
