 ...
 *   - SANREMES AGENT wordmark rendered in Collapse Bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -SanRemesHome
 * flag. Showing %LOCALAPPDATA% to grandma is developer-brain.
 */
export default function Welcome() {
  return (
    <div className="sanremes-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>SANREMES AGENT</span>
          </span>
          <span aria-hidden="true">SANREMES AGENT</span>
        </p>
