...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @sanremes/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@sanremes/shared'],
              message: 'Plugins import only @sanremes/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
