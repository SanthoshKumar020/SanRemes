...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.sanremesMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.sanremesMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.sanremesMode = 'light'
