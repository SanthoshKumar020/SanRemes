...
const copy = {
  ...
  availableBody: 'A new version of SanRemes is ready to install.',
  availableTitleBackend: 'Backend update available',
  availableBodyBackend: 'A newer version of the connected SanRemes backend is ready to install.',
...
describe('resolveUpdateCopy', () => {
  it('client target with commits: client title + client body', () => {
    ...
    expect(r.body).toBe('A new version of SanRemes is ready to install.')
  })
