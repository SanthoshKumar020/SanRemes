...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|sanremes):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.sanremesDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.sanremesDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of SanRemes, and it is the surface the agent
