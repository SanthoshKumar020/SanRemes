...
import type { ModelOptionsResponse, SessionInfo } from '@/types/sanremes'
 ...
 *
 * Only the leading status prefix (e.g. "SanRemes is thinking...") and the
 ...
 *  resolved comment as JSON (SanRemesPrComment shape); a malformed payload falls
