...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/sanremes-agent')).toBe('~/www/sanremes-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/sanremes-agent')).toBe('sanremes-agent')
    expect(pathLeaf('~/www/sanremes-agent')).toBe('sanremes-agent')
