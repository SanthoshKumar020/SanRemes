...
export const en: Translations = {
  ...
  boot: {
    ready: 'SanRemes Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading SanRemes settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote SanRemes backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingSanRemesDesktop: 'Starting SanRemes Desktop…'
    },
    errors: {
      backgroundExited: 'SanRemes background process exited.',
      backgroundExitedDuringStartup: 'SanRemes background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your SanRemes backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSanRemes: 'Update SanRemes',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting SanRemes Desktop.',
    ...
    native: {
      ...
      inputBody: 'SanRemes is waiting for your response.',
      turnDoneTitle: 'SanRemes finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `sanremes debug share --nous` from a terminal, or `sanremes debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to SanRemes defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the SanRemes backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the SanRemes backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.sanremes/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while SanRemes is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'SanRemes asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while SanRemes was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while SanRemes was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let SanRemes follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and SanRemes can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by SanRemes when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let SanRemes walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what SanRemes is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen SanRemes, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'SanRemes Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The SanRemes runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'SanRemes checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading SanRemes configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening SanRemes.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every SanRemes gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by SanRemes Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'SanRemes Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The SanRemes runtime managed by this app.',
      kindRemoteDesc: 'A SanRemes gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your SanRemes Cloud account.',
      kindSshDesc: 'A SanRemes install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers SanRemes manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under SanRemes Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a SanRemes backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SANREMES_DESKTOP_REMOTE_URL and SANREMES_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private SanRemes backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote SanRemes backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'SanRemes Cloud',
      cloudDesc: 'Sign in once to SanRemes Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'SanRemes Cloud',
      cloudSignIn: 'Sign in to SanRemes Cloud',
      cloudSignedIn: 'Signed in to SanRemes Cloud',
      cloudNeedsSignIn: 'Sign in to SanRemes Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your SanRemes Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'SanRemes Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of SanRemes Cloud',
      cloudSignedOutMessage: 'Cleared the SanRemes Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /sanremes.',
      ...
      restartingMessage: 'SanRemes Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · SanRemes ${version}` : ''}`,
      ...
      sshDesc:
        'SanRemes is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSanRemesPathTitle: 'SanRemes path (optional)',
      sshSanRemesPathDesc: 'Full path to the remote sanremes binary. Blank = auto-detect.',
      sshSanRemesPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — SanRemes found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — SanRemes runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'SanRemes is not installed on the remote host. Install it there (curl -fsSL https://sanremes-agent.nousresearch.com/install.sh | sh) or set the SanRemes path.',
      sshErrPlatform:
        'Unsupported remote platform. SanRemes Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update SanRemes on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to SanRemes. Review the exact configuration below — it comes from the link, not from SanRemes.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. SanRemes runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point SanRemes at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via sanremes curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As SanRemes builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart SanRemes to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update SanRemes to generate pets.',
      backgroundHint: 'You can close this — SanRemes will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure SanRemes desktop' },
    ...
    sanremesActiveSessions: (version, count) => `SanRemes ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@sanremes:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent SanRemes environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'SanRemes did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. SanRemes will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the SanRemes backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from SanRemes. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the SanRemes backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting SanRemes...',
    placeholderReconnecting: 'Reconnecting to SanRemes…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give SanRemes a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'SanRemes will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask SanRemes to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating SanRemes…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting SanRemes…',
    ...
    unsupportedMessage: 'This version of SanRemes can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the SanRemes desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The SanRemes updater takes over in its own window and reopens SanRemes automatically when it’s done. Please don’t reopen SanRemes yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. SanRemes reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then SanRemes reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update SanRemes?',
    blockerBody:
      'SanRemes needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update SanRemes',
    foreignBlockerBody:
      'SanRemes can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'SanRemes can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'SanRemes needs a one-time install',
    ...
    setupChoiceTitle: 'Set up SanRemes Desktop',
    setupChoiceDesc:
      'Connect this app to a SanRemes gateway you already run, or install SanRemes locally on this computer.',
    connectExistingTitle: 'Connect to existing SanRemes',
    ...
    installLocalTitle: 'Install SanRemes locally',
    ...
    probeError: 'Could not reach that SanRemes gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up SanRemes Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another SanRemes CLI or desktop instance is running. Stop any running SanRemes instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with SanRemes Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'SanRemes is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting SanRemes…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run SanRemes',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — SanRemes connects automatically',
    ...
    authorizeThere: 'Authorize SanRemes there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize SanRemes there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `SanRemes Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `SanRemes Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. SanRemes will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'SanRemes is restarting...',
      askRestart: 'Ask SanRemes to restart the server',
      lookingRestart: taskId => `SanRemes is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'SanRemes is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask SanRemes to open a page.',
      finishedRestarting: message => `SanRemes finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'SanRemes could not restart the server.',
      stillWorking:
        'SanRemes is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'SanRemes is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'SanRemes gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.sanremes/config.yaml). SanRemes won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'SanRemes needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'SanRemes needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart SanRemes Desktop to use Save Image.',
    restartToSaveImages: 'Restart SanRemes Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `sanremes gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions SanRemes loads when the work calls for them.'
      },
      messaging: {
        title: 'SanRemes away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything SanRemes made',
      ...
      profiles: {
        ...
        text: 'Each one is its own SanRemes — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
