...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingSanRemesDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSanRemesPathTitle: string
      sshSanRemesPathDesc: string
      sshSanRemesPathPlaceholder: string
  ...
  commandCenter: {
    ...
    sanremesActiveSessions: (version: string, count: number) => string
