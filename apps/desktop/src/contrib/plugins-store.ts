 ...
 * `<sanremes home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'sanremes.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'sanremes.desktop.disabledPlugins.v1'
