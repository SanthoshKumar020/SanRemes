...
/**
 * Nous — the canonical SanRemes desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays SanRemes's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical SanRemes desktop identity: GitHub's chrome carrying Nous
