/**
 * SanRemes skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$SANREMES_HOME/skins/` (or a
 * built-in) resolved by `sanremes_cli/skin_engine.py` and pushed to every surface
 ...
 * skin SanRemes authors from a prompt lights up all three surfaces from one file.
 *
...
import type { SanRemesSkin, SkinColors } from '@sanremes/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: SanRemesSkin): DesktopTheme | null {
