...
import { type PluginLocaleBundles, type PluginTranslate, usePluginI18n } from '@sanremes/plugin-sdk'
...
const en: BotsMessages = {
  roster: {
    ...
    rosterUnavailable: reason =>
      `Roster unavailable: ${reason}. If your gateway predates profiles.list, update SanRemes and restart the gateway.`,
    waitingForGateway:
  ...
  bot: {
    ...
    openAnotherChatUnsupported: 'Update SanRemes Desktop to open another Bot chat.',
    remoteConnectionsUnsupported: 'Update SanRemes Desktop to chat with bots on other connections.',
...
const ja: BotsMessages = {
  roster: {
    ...
    retryNow: '今すぐ再試行',
    rosterUnavailable: reason =>
      `名簿を取得できません: ${reason}。ゲートウェイが profiles.list より前の場合は、SanRemes を更新してゲートウェイを再起動してください。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '別のボットチャットを開くには SanRemes Desktop を更新してください。',
    remoteConnectionsUnsupported: '他の接続上のボットとチャットするには SanRemes Desktop を更新してください。',
...
const zh: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重试',
    rosterUnavailable: reason => `无法获取名单：${reason}。如果网关早于 profiles.list，请更新 SanRemes 并重启网关。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '请更新 SanRemes Desktop 以打开另一个机器人聊天。',
    remoteConnectionsUnsupported: '请更新 SanRemes Desktop 以与其他连接上的机器人聊天。',
    chatEmpty: '说点什么开始吧。',
    kickoff: '你好，介绍一下你自己吧！'
  },
  avatar: {
...
const zhHant: BotsMessages = {
  roster: {
    ...
    unavailable: '不可用',
    retryNow: '立即重試',
    rosterUnavailable: reason => `無法取得名單：${reason}。如果閘道早於 profiles.list，請更新 SanRemes 並重新啟動閘道。`,
  ...
  bot: {
    ...
    openAnotherChatUnsupported: '請更新 SanRemes Desktop 以開啟另一個機器人聊天。',
    remoteConnectionsUnsupported: '請更新 SanRemes Desktop 以與其他連線上的機器人聊天。',
    chatEmpty: '說點什麼開始吧。',
    kickoff: '你好，介紹一下你自己吧！'
  },
  avatar: {
...
export function useBots(): BotsText {
  const t = usePluginI18n('sanremes-bots')
