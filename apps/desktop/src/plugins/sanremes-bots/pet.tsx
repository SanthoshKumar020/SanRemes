...
import { Button, cn, GlyphSpinner, host, Input, LruCache, RowButton, useQuery } from '@sanremes/plugin-sdk'
  ...
  if (!pets.length) {
    return (
      <div className="px-2 py-3 text-center text-xs text-(--ui-text-tertiary)">
        No pets in the petdex gallery. Run `sanremes pets` to explore.
      </div>
    )
  }
