 ...
 *    the primary profile surfaced as @default instead of @sanremes;
 ...
 *    kanban/tool workers count too (sanremes-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @sanremes, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('sanremes')
