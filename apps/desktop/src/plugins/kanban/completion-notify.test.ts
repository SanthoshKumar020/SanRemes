 ...
 * renderer process. The @sanremes/plugin-sdk host is mocked: notify/navigate
 * calls are asserted, never really executed.
 */

import type { PluginRestOptions } from '@sanremes/plugin-sdk'
