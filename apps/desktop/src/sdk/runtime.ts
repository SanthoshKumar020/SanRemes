 ...
 * plugins resolve `@sanremes/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SANREMES_PLUGIN_SDK__: sdk,
  __SANREMES_REACT__: React,
  __SANREMES_REACT_JSX__: jsxRuntime,
  __SANREMES_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@sanremes/plugin-sdk': shimUrl('__SANREMES_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SANREMES_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SANREMES_REACT_JSX__'),
    react: shimUrl('__SANREMES_REACT__')
  }
