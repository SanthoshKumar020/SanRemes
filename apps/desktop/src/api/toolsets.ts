...
export function getToolsets(profile?: ProfileScope): Promise<ToolsetInfo[]> {
  return window.sanremesDesktop.api<ToolsetInfo[]>({
...
export function setToolsetEnabled(
  ...
  return window.sanremesDesktop.api<{ ok: boolean; name: string; enabled: boolean }>({
    ...capabilityScoped(profile),
...
export function getToolsetConfig(name: string, profile?: ProfileScope): Promise<ToolsetConfig> {
  return window.sanremesDesktop.api<ToolsetConfig>({
    ...capabilityScoped(profile),
...
export function getToolsetModels(
  ...
  return window.sanremesDesktop.api<ToolsetModelsResponse>({
    ...capabilityScoped(profile),
...
export function selectToolsetModel(
  ...
  return window.sanremesDesktop.api<{ ok: boolean; name: string; model: string }>({
    ...capabilityScoped(profile),
...
export function selectToolsetProvider(
  ...
  return window.sanremesDesktop.api<SelectToolsetProviderResponse>({
    ...capabilityScoped(profile),
...
export function runToolsetPostSetup(
  ...
  return window.sanremesDesktop.api<ActionResponse & { key: string }>({
    ...capabilityScoped(profile),
...
export function getTerminalBackends(): Promise<TerminalBackendsResponse> {
  return sanremesApi<TerminalBackendsResponse>({
    ...profileScoped(),
...
export function selectTerminalBackend(backend: string): Promise<{ ok: boolean; backend: string }> {
  return sanremesApi<{ ok: boolean; backend: string }>({
    ...profileScoped(),
...
export function getComputerUseStatus(): Promise<ComputerUseStatus> {
  return sanremesApi<ComputerUseStatus>({
    ...profileScoped(),
