...
export function updateMessagingPlatform(
  ...
  return sanremesApi<{ ok: boolean; platform: string }>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return sanremesApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return sanremesApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return sanremesApi<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(profile),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return sanremesApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return sanremesApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return sanremesApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return sanremesApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
