...
import type { ModelOptionProvider, OAuthProvider } from '@/types/sanremes'
...
const API_KEY_OPTIONS: ApiKeyOption[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://github.com/NousResearch/sanremes-agent#bring-your-own-endpoint',
    placeholder: 'http://127.0.0.1:8000/v1'
  }
]

// Build the FULL API-key provider catalog from the backend model options so the
// onboarding / Providers key form lists every `api_key` provider `sanremes model`
...
const SHOW_ALL_KEY = 'sanremes-onboarding-show-all-v1'
