...
const STORAGE_KEY = 'sanremes.desktop.layoutTree.v2'

writeKey('sanremes.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('sanremes.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('sanremes.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'sanremes.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'sanremes.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'sanremes.desktop.hiddenStripTabs.v1'
...
writeKey('sanremes.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SANREMES_LAYOUT_TREE__ = {
    close: closeTreePane,
