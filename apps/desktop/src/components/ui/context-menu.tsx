...
export const SANREMES_CONTEXT_MENU_TRIGGER_ATTR = 'data-sanremes-context-menu-trigger'

function ContextMenuTrigger({ ...props }: React.ComponentProps<typeof ContextMenuPrimitive.Trigger>) {
  return (
    <ContextMenuPrimitive.Trigger data-slot="context-menu-trigger" {...props} data-sanremes-context-menu-trigger="" />
  )
}
