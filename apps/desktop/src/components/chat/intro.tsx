...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should SanRemes look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} SanRemes need to see?`,
    ...
    {
      headline: `What should ${label} SanRemes tackle?`,
