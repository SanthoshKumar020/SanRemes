...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://sanremes.example.com:8443/x')).toBe('sanremes.example.com:8443')
    expect(remoteHostLabel('https://sanremes.example.com:443')).toBe('sanremes.example.com')
    expect(remoteHostLabel('http://sanremes.example.com:80')).toBe('sanremes.example.com')
  })
