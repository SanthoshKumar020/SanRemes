...
export interface PetInfo {
  ...
  // the SanRemes "run" activity state uses the in-place running row).
 ...
 * SANREMES_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'sanremes.desktop.pet-roam.v1'
