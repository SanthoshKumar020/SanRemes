 ...
 * - It covers SanRemes too. "Off" from someone who has just closed a bubble means
...
export const $tipsEnabled = persistentAtom('sanremes.desktop.tips.rotation.v1', true, Codecs.bool)
export const $retiredTips = persistentAtom<string[]>('sanremes.desktop.tips.retired.v1', [], Codecs.stringArray)
export const $lastTipId = persistentAtom<null | string>('sanremes.desktop.tips.last.v1', null, Codecs.nullableText)
export const $nextTipAt = persistentAtom<null | number>(
  'sanremes.desktop.tips.next.v1',
  null,
