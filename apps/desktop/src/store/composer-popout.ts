...
const POPOUT_STORAGE_KEY = 'sanremes.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'sanremes.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'sanremes.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'sanremes.desktop.composerPopout.position'
