 ...
 * unlike tips there is no ambient half to separate out — every tour is SanRemes
...
export const $toursEnabled = persistentAtom('sanremes.desktop.tours.v1', true, Codecs.bool)
