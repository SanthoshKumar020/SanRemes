...
function identityForConnection(connection: SanRemesConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SanRemesConnection | null): void {
