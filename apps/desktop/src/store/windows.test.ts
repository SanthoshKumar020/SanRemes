...
function installBridge(
  openSessionWindow?: Window['sanremesDesktop']['openSessionWindow'],
  openWindow?: Window['sanremesDesktop']['openWindow'],
  openBrowserWindow?: Window['sanremesDesktop']['openBrowserWindow']
) {
