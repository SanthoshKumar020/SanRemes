...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('sanremes.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('sanremes.desktop.unreadFinishedSessions')
