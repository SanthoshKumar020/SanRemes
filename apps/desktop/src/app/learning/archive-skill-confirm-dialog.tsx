...
import { deleteLearningNode, type ProfileScope } from '@/sanremes'
import { notify } from '@/store/notifications'

export const ARCHIVE_SKILL_DESCRIPTION = 'The skill is archived and can be restored with `sanremes curator restore`.'
