...
import { transcribeAudio } from '@/sanremes'
...
export function usePromptActions({
  ...
  // succeeds on SANREMES01 and prompt.submit immediately fails locally with
  // "session not found".
  ...
  // separate `sanremes gateway` process performs the actual transfer, so we
