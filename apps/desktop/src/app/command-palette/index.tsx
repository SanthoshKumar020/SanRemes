...
import { getSanRemesConfigRecord, listAllProfileSessions } from '@/sanremes'
...
// SanRemes session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getSanRemesConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-sanremes',
            keywords: ['update', 'upgrade', 'sanremes', 'version', 'system', 'restart'],
            label: cc.updateSanRemes,
