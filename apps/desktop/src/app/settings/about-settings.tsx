...
const RELEASE_NOTES_URL = 'https://github.com/NousResearch/sanremes-agent/releases'
const INSTALLER_URL = 'https://sanremes-agent.nousresearch.com/'
                ...
                <Button asChild className="mt-2" size="sm" variant="textStrong">
                  <a
                    ...
                    onClick={event => {
                      ...
                      void window.sanremesDesktop?.openExternal?.(INSTALLER_URL)
                    }}
                    rel="noreferrer"
                    target="_blank"
                  >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.sanremesDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
