...
const searchCopy = {
  fieldDescriptions: {
    'display.personality': 'Choose how SanRemes sounds in conversation.',
...
describe('settings search index', () => {
  it('builds config results from renderable schema fields with exact deep links', () => {
    ...
    } as unknown as SanRemesConfigRecord
    ...
    expect(entries[0]).toMatchObject({
      context: 'Chat',
      description: 'Choose how SanRemes sounds in conversation.',
      label: 'Personality',
