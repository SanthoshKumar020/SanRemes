...
import { saveMemoryProviderConfig } from '@/sanremes'
import { notify, notifyError } from '@/store/notifications'
import { $activeGatewayProfile } from '@/store/profile'
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/sanremes'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.sanremesDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
