...
vi.mock('@/sanremes', () => ({
  saveSanRemesConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setSanRemesConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useSanRemesConfigRecord: () => ({ data: mocks.loadedConfig })
}))
