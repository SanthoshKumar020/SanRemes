...
import { getActionStatus, getComputerUseStatus, grantComputerUsePermissions } from '@/sanremes'
import { upsertDesktopActionTask } from '@/store/activity'
import { notify, notifyError } from '@/store/notifications'
import type { ComputerUseStatus } from '@/types/sanremes'
 ...
 * cua-driver's own `com.trycua.driver` identity — not SanRemes — and are
        ...
        <div className="min-w-0">
          {status.can_grant ? (
            <p className="text-[0.72rem] text-muted-foreground">
              Grants attach to CuaDriver&apos;s own identity (com.trycua.driver), not SanRemes — so the dialog is
