...
import type { ConfigFieldSchema, SanRemesConfigRecord, ToolsetInfo } from '@/types/sanremes'
...
export function getNested(obj: SanRemesConfigRecord, path: string): unknown {
  let cur: unknown = obj
 ...
 */
export function clearsEnabledToolsets(prev: SanRemesConfigRecord, next: SanRemesConfigRecord): boolean {
...
export function voiceFieldVisible(key: string, config: SanRemesConfigRecord): boolean {
...
export function setNested(obj: SanRemesConfigRecord, path: string, value: unknown): SanRemesConfigRecord {
...
function personalityOptions(config: SanRemesConfigRecord): string[] {
...
function commandProviderNames(config: SanRemesConfigRecord, section: 'tts' | 'stt'): string[] {
