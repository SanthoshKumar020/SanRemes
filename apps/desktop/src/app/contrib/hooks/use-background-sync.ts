...
import { getLatestSessionMessages, type ProfileScope } from '@/sanremes'
...
interface BackgroundSyncParams {
  ...
  refreshSanRemesConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshSanRemesConfig])
}
