...
registry.registerMany([
  ...
  // The agent's write -> see loop: rescan <sanremes home>/desktop-plugins
  ...
  // The keybind panel's non-titlebar door (the keyboard icon is gone).
  {
    ...
    data: {
      ...
      run: () => window.dispatchEvent(new CustomEvent('sanremes:open-keybinds'))
    } satisfies PaletteContribution
  },
    ...
    >
      <ContribWiring>
        ...
        <div
          ...
          // [data-sanremes-glass] rules in styles.css clear them so the tint
