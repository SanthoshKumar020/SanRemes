import type { SanRemesReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SanRemesReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SanRemesReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
