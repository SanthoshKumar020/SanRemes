...
const TAKEOVER_KEY = 'sanremes.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which SanRemes can't clear via the API — the user
 *  sees exactly what runs instead of SanRemes silently deleting their creds. */
