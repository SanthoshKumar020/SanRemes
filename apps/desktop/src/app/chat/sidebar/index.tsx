...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/sanremes'
...
// highlight markers (sqlite snippet() delimiters — see sanremes_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('sanremes:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('sanremes:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask SanRemes to
