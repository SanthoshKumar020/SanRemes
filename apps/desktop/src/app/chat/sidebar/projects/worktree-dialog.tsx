...
import type { SanRemesGitBranch } from '@/global'
...
const branchActionLabel = (branch: SanRemesGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<SanRemesGitBranch[]>([])
  ...
  const convert = async (branch: SanRemesGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
