...
import { type DroppedFile, extractDroppedFiles, SANREMES_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, SANREMES_PATHS_MIME) ? 'files' : null
