...
const FOCUS_EVENT = 'sanremes:composer-focus'
const INSERT_EVENT = 'sanremes:composer-insert'
const ATTACH_IMAGES_EVENT = 'sanremes:composer-attach-images'
const INSERT_REFS_EVENT = 'sanremes:composer-insert-refs'
const SUBMIT_EVENT = 'sanremes:composer-submit'
const VOICE_TOGGLE_EVENT = 'sanremes:composer-voice-toggle'
const MODEL_MENU_EVENT = 'sanremes:composer-model-menu'
