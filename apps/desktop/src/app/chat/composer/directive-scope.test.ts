...
describe('directive scope is a browse mode, not text to maintain', () => {
  ...
  it('pasting into an open @url: scope consumes it instead of stacking', () => {
    ...
    paste(editor, 'https://github.com/NousResearch/sanremes-agent/pull/74533')

    expect(composerPlainText(editor)).toBe('refer to @url:`https://github.com/NousResearch/sanremes-agent/pull/74533`')
