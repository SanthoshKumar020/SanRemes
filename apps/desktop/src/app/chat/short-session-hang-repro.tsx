...
const fixtures: FixtureTurn[] = [
  ...
  turn(3, 'tools', [
    {
      args: { path: '/tmp/sanremes-short-session-fixture.txt' },
      argsText: '{"path":"/tmp/sanremes-short-session-fixture.txt"}',
  ...
  turn(8, 'mixed', [
    text('Mixed response eight is the final checkpoint. `inline code` and **markdown** remain interactive.'),
    {
      args: { path: '/tmp' },
      argsText: '{"path":"/tmp"}',
      result: { entries: ['sanremes-short-session-fixture.txt'], ok: true },
