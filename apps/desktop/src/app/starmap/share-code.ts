...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/sanremes'
...
const VERSION = 3
const PREFIX = 'HML' // "SanRemes Memory Loadout" — namespaces our codes like WoW's leading bytes.
