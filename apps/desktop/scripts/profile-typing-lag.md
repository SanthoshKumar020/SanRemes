...
cd apps/desktop
XCURSOR_SIZE=24 SANREMES_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/sanremes-typing
# → /tmp/sanremes-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/sanremes-typing.before.heapsnapshot
# → /tmp/sanremes-typing.after.heapsnapshot
```
