...
const emojibaseAssets = () => ({
  name: 'sanremes:emojibase-assets',
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\sanremes\sanremes-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@sanremes/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@sanremes/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@sanremes/shared': path.resolve(__dirname, '../shared/src'),
