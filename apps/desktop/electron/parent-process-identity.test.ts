...
test('parentWatchdogEnv emits an exact identity when the marker is available', () => {
  assert.deepEqual(parentWatchdogEnv(42, 'winms:1723456789123', 'nonce-1'), {
    SANREMES_PARENT_NONCE: 'nonce-1',
    SANREMES_PARENT_PID: '42',
    SANREMES_PARENT_START_MARKER: 'winms:1723456789123',
    // Spawn tag mirrored by sanremes_cli/process_identity.py — spawner create
    // time in seconds derived from the same winms marker.
    SANREMES_SPAWN: 'v1:-:serve:42:1723456789.123'
  })
})
