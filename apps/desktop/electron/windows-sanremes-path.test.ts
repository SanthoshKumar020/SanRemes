...
test('chooseUpdaterArgs: gentle --update when both updater runtime files exist', () => {
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvSanRemes: true, hasVenvPython: true }, 'main'),
    ['--update', '--branch', 'main']
  )
})
...
test('chooseUpdaterArgs: partial updater runtimes use --repair', () => {
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvSanRemes: false, hasVenvPython: true }, 'main'),
    ['--repair', '--branch', 'main']
  )
  assert.deepEqual(
    chooseUpdaterArgs({ hasBootstrapMarker: true, hasVenvSanRemes: true, hasVenvPython: false }, 'main'),
    ['--repair', '--branch', 'main']
  )
})
