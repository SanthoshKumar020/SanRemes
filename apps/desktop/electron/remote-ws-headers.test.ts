...
function expectRequestHeaders(
  ...
  applyRemoteRequestHeaders({ url, requestHeaders: { Origin: 'app://sanremes' } }, callback, store.headersFor)

  expect(callback).toHaveBeenCalledOnce()
  expect(callback).toHaveBeenCalledWith(expected ? { requestHeaders: { Origin: 'app://sanremes', ...expected } } : {})
}
