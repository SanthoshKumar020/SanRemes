 ...
 *
 * A public install can end up with `origin=git@github.com:NousResearch/sanremes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/NousResearch/sanremes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/nousresearch/sanremes-agent'
