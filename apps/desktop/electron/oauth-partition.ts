 ...
 * (`persist:sanremes-remote-oauth`) — the jar was keyed on the auth *mode*, not
 ...
 * setup: one box, two dashboards) fought over the same `sanremes_session*`
...
export const LEGACY_OAUTH_PARTITION = 'persist:sanremes-remote-oauth'
