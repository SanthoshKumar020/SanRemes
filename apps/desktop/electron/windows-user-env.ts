...
// even though a fresh shell — and the SanRemes CLI — sees it immediately. The
// desktop's SANREMES_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\sanremes. Reading
...
//       SANREMES_HOME    REG_SZ    F:\SanRemes\data
//
