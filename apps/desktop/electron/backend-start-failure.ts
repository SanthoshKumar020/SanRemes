 ...
 * startSanRemes() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSanRemes() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSanRemes`, re-emits
