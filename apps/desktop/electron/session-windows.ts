...
// by main.ts (`setBackgroundThrottling` driven by the merged `sanremes:active-work`
...
// (the "SanRemes idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey SanRemes" wake word has NO preceding click,
