...
const hudWindow = win({ app: 'SanRemes', bounds: { x: 970, y: 1048, width: 620, height: 320 }, id: 2, pid: SELF_PID })
...
test('own windows never count, wherever they sit in the z-order', () => {
  const selfFullscreen = win({ app: 'SanRemes', bounds: { ...DISPLAY }, pid: SELF_PID })
