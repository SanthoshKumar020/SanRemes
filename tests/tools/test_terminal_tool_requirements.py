...
class TestCheckFnTransientFailureSuppression:
    ...
    def test_profile_scoped_availability_does_not_cross_multiplex_profiles(
        ...
        try:
            home_a = set_sanremes_home_override(str(profile_a))
            ...
            try:
                ...
                reset_sanremes_home_override(home_a)

            home_b = set_sanremes_home_override(str(profile_b))
            ...
            try:
                ...
                reset_sanremes_home_override(home_b)
