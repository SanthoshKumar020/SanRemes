...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "sanremes-session"
...
def test_backends_are_isolated_by_sanremes_session_and_reused_within_it():
...
def test_concurrent_sanremes_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
