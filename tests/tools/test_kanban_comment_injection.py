...
def worker_home(tmp_path, monkeypatch):
    ...
    for var in ("SANREMES_KANBAN_DB", "SANREMES_KANBAN_WORKSPACES_ROOT", "SANREMES_KANBAN_HOME", "SANREMES_KANBAN_BOARD"):
...
def test_seed_then_inject_new_comment(worker_home, monkeypatch):
    ...
    monkeypatch.setenv("SANREMES_PROFILE", "worker-bot")
    agent = FakeAgent()
