...
def ledger_env(tmp_path, monkeypatch):
    """Isolated SANREMES_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_sanremes_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_sanremes_home", lambda: home)
...
def test_rollback_refuses_paths_outside_sanremes_home(ledger_env):
    """A hand-edited ledger entry pointing outside SANREMES_HOME must not
