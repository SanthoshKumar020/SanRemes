...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/sanremes config files without modify intent.
        ...
        assert _scan_memory_content("Read .sanremes/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .sanremes/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .sanremes/config.yaml to change settings", "sanremes_config_mod")
        _blocked("update .sanremes/SOUL.md with new personality", "sanremes_config_mod")
