...
Real config files in a temp SANREMES_HOME, real resolution chains (no mocked
...
def voice_home(tmp_path, monkeypatch):
    """Isolated SANREMES_HOME + reloaded config modules; yields a config writer."""
    ...
    for var in (
        ...
        "DEEPINFRA_API_KEY", "SANREMES_LOCAL_STT_LANGUAGE",
    ):
