...
must match regardless of host OS (a Linux-hosted SanRemes can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\sanremes\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/sanremes/.env",
    ])
