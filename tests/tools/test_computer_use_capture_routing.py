...
* ``sanremes_constants.get_sanremes_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_sanremes_dir so cache writes land under tmp_path."""
    ...
    with patch("sanremes_constants.get_sanremes_dir", _fake_get):
        yield cache_dir
