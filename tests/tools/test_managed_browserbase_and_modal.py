...
def _enable_managed_nous_tools(monkeypatch):
    ...
    sanremes_cli.nous_account — so the function body returns True.
    """
    monkeypatch.setattr(
        "sanremes_cli.nous_account.get_nous_portal_account_info",
...
def _install_fake_tools_package():
    ...
    # sanremes_cli.auth (imported transitively by nous_account /
