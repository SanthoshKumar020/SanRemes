...
def _bump_view_many(sanremes_home: str, skill_name: str, iterations: int) -> None:
    os.environ["SANREMES_HOME"] = sanremes_home
...
def skills_home(tmp_path, monkeypatch):
    """Isolated SANREMES_HOME with a clean skills/ dir for each test.
