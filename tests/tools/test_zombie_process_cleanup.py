...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from sanremes_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["sanremes_home"] = get_sanremes_home()
        ...
        assert observed["sanremes_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_sanremes_home_override(profile_home)
        ...
        try:
            ...
            release_child.set()
            reset_sanremes_home_override(profile_token)
            relay_runtime._reset_for_tests()
