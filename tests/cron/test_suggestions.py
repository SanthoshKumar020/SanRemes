...
SANREMES_HOME so the real suggestions.json is never touched.
"""
...
def store(tmp_path, monkeypatch):
    """A cron.suggestions module bound to an isolated SANREMES_HOME."""
...
class TestCommandHandler:
    def test_bare_lists_pending(self, store):
        ...
        with patch("cron.suggestions.list_pending", store.list_pending):
            from sanremes_cli.suggestions_cmd import handle_suggestions_command
