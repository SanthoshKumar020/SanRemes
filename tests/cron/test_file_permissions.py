...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("sanremes_cli.config.get_config_path", return_value=config_path), \
             patch("sanremes_cli.config.ensure_sanremes_home"):
    ...
    def test_ensure_sanremes_home_sets_0700(self):
        home = Path(self.tmpdir) / ".sanremes"
