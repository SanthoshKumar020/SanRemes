...
class TestSlackSyntheticThreadCapture:
    def test_synthetic_slack_thread_not_captured(self):
        ...
        env = {
            "SANREMES_SESSION_PLATFORM": "slack",
            "SANREMES_SESSION_CHAT_ID": "D0BJTDCSR7C",
            "SANREMES_SESSION_THREAD_ID": "1755043010.123456",
            "SANREMES_SESSION_MESSAGE_ID": "1755043010.123456",
        }
    ...
    def test_genuine_slack_thread_preserved(self):
        ...
        env = {
            "SANREMES_SESSION_PLATFORM": "slack",
            "SANREMES_SESSION_CHAT_ID": "C0AGENERAL",
            "SANREMES_SESSION_THREAD_ID": "1755040000.000100",
            "SANREMES_SESSION_MESSAGE_ID": "1755043010.123456",
        }
        with _session_env(env):
            origin = _origin_from_env()
    ...
    def test_non_slack_platform_thread_untouched(self):
        ...
        env = {
            ...
            "SANREMES_SESSION_CHAT_ID": "-1003941067111",
            "SANREMES_SESSION_THREAD_ID": "2203",
            "SANREMES_SESSION_MESSAGE_ID": "2203",
        }
        with _session_env(env):
            origin = _origin_from_env()
        assert origin is not None
