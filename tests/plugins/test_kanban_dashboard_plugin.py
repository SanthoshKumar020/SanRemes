...
def _load_plugin_router():
    ...
    spec = importlib.util.spec_from_file_location(
        "sanremes_dashboard_plugin_kanban_test", plugin_file,
    )
...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "sanremes_cli.web_server", stub)
    monkeypatch.setattr(sanremes_cli, "web_server", stub, raising=False)
...
# tests/sanremes_cli/test_kanban_db.py. The OUTER fallback here is not, which
