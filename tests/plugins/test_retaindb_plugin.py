...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure SANREMES_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", sanremes_home=str(tmp_path / ".sanremes"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("SANREMES_HOME", str(sanremes_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", sanremes_home=str(sanremes_home))
        return p
