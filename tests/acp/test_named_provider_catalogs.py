...
from acp_adapter.server import SanRemesACPAgent, _named_custom_provider_catalogs
...
class TestNamedCustomProviderCatalogs:
    ...
    def test_live_discovery_extends_declared_models(self, monkeypatch):
        ...
        with patch("sanremes_cli.config.load_config", return_value=cfg), patch(
            "sanremes_cli.model_switch._fetch_picker_live_models",
    ...
    def test_disabled_provider_skipped(self, monkeypatch):
        ...
        with patch("sanremes_cli.config.load_config", return_value=cfg), patch(
            "sanremes_cli.model_switch._fetch_picker_live_models", return_value=None
        ):
    ...
    def test_native_empty_catalog_is_authoritative_over_default_model(self):
        ...
        from sanremes_cli.model_switch import _NativePickerModelList
...
class TestModelStateIncludesNamedProviders:
    ...
    async def test_authoritative_empty_named_catalog_does_not_resurrect_current_model(self):
        ...
        with patch("sanremes_cli.models.curated_models_for_provider", return_value=[]), patch(
    ...
    async def test_named_provider_models_appear_in_model_state(self):
        ...
        with patch(
            "sanremes_cli.models.curated_models_for_provider",
    ...
    def test_selector_choice_id_round_trips_through_parse_model_input(self):
        ...
        from sanremes_cli.models import parse_model_input
