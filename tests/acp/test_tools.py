...
COMMON_SANREMES_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_sanremes_tools_have_kind(self):
        """Every common sanremes tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_SANREMES_TOOLS:
...
class TestBuildToolTitle:
    ...
    def test_execute_code_title_includes_first_code_line(self):
        ...
        assert title == "python: from sanremes_tools import terminal"
