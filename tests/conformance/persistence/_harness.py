...
def make_sanremes_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated SANREMES_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"sanremes-home-{journal_mode}"
