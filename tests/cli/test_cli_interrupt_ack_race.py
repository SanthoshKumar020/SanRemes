...
Root cause: ``SanRemesCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a SanRemesCLI with prompt_toolkit stubbed (same pattern as
