...
in SanRemesCLI.process_command — so typing it printed "Unknown command:
...
class TestHandleIndicatorCommand(unittest.TestCase):
    ...
    def test_no_args_shows_status(self):
        ...
        with (
            ...
            cli_mod.SanRemesCLI._handle_indicator_command(stub, "/indicator")
    ...
    def test_status_argument_shows_status(self):
        ...
        with (
            ...
            cli_mod.SanRemesCLI._handle_indicator_command(stub, "/indicator status")
    ...
    def test_valid_style_saves_to_config_key(self):
        ...
        with (
            ...
            cli_mod.SanRemesCLI._handle_indicator_command(stub, "/indicator unicode")
    ...
    def test_invalid_style_prints_usage_and_does_not_save(self):
        ...
        with (
            ...
            cli_mod.SanRemesCLI._handle_indicator_command(stub, "/indicator rainbow")
...
class TestIndicatorRegistry(unittest.TestCase):
    def test_indicator_in_registry(self):
        from sanremes_cli.commands import COMMAND_REGISTRY
    ...
    def test_indicator_subcommands_match_handler(self):
        from sanremes_cli.commands import COMMAND_REGISTRY
        from sanremes_constants import INDICATOR_STYLES
