...
def test_interrupted_session_end_skipped_for_handed_off():
    ...
    with patch("sanremes_cli.lifecycle.invoke_hook") as mock_hook:
...
def test_cleanup_does_not_finalize_handed_off_session():
    ...
    with (
        patch("sanremes_cli.lifecycle.finalize_session") as mock_finalize,
...
def test_single_query_finalize_skipped_for_handed_off():
    ...
    with patch("sanremes_cli.lifecycle.finalize_session") as mock_finalize:
