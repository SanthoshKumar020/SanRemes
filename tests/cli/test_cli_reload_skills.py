"""Tests for the ``/reload-skills`` CLI slash command (``SanRemesCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal SanRemesCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.SanRemesCLI)
