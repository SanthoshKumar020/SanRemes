...
window keeps moving through the long silent stretches (`sanremes update`, pip,
...
def test_progress_advances_while_the_orchestrator_blocks(tmp_path: Path) -> None:
    ...
    env["SANREMES_SELFTEST_HOLD_SECONDS"] = "30"
    ...
    try:
        ...
        # boot default instead ('SanRemes will open once done.' ==
