...
class TestStripOptionalSystemdDirectives:
    def test_removes_restart_max_delay_sec(self):
        from sanremes_cli.gateway import _strip_optional_systemd_directives
        text = """[Service]
Restart=always
RestartSec=5
...
[Service]
Type=simple
ExecStart=/usr/bin/python -m sanremes_cli.main gateway run
Restart=always
RestartSec=5
KillMode=mixed
KillSignal=SIGTERM
...
"""
        ...
        unit_file = tmp_path / "sanremes-gateway.service"
