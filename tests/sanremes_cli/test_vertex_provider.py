...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (sanremes_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_sanremes_overlays():
    """sanremes_cli.providers.get_provider("vertex") backs
