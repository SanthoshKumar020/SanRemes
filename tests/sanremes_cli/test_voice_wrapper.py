"""Tests for ``sanremes_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestPublicAPI:
    def test_gateway_symbols_importable(self):
        ...
        from sanremes_cli.voice import (
            speak_text,
            start_recording,
            stop_and_transcribe,
        )
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_non_string_falls_back_to_default(self):
        from sanremes_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    # parser rejects alt+c/d/l because sanremes-ink reports Alt as
    ...
    def test_pt_key_to_sequence(self):
        from sanremes_cli.voice import pt_key_to_sequence
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_missing_record_key_returns_none(self):
        from sanremes_cli.voice import voice_record_key_from_config
...
class TestFormatVoiceRecordKeyForStatus:
    ...
    def test_ctrl_and_alt_letter_keys_render_canonically(self):
        from sanremes_cli.voice import format_voice_record_key_for_status
...
class TestSpeakTextGuards:
    ...
    def test_speak_text_uses_returned_tts_file_path(self, monkeypatch):
        ...
        played = []
        returned_path = "/tmp/sanremes_voice/actual.flac"
