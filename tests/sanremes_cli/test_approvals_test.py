"""Tests for ``sanremes approvals test`` — dry-run approval verdict CLI.
...
from sanremes_cli import approvals_test as at
...
class TestOutputAndWiring:
    ...
    def test_dispatcher_routes_test_subcommand(self, isolated_approvals, capsys):
        from sanremes_cli.approvals_suggest import approvals_command
        args = _args(["ls"])
