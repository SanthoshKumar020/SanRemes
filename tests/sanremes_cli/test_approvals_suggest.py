"""Tests for ``sanremes approvals suggest`` (sanremes_cli/approvals_suggest.py).

Approval history in SanRemes is implied, not ledgered: the session DB
...
from sanremes_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
...
class TestParserWiring:
    def test_build_approvals_parser_wires_suggest(self):
        ...
        from sanremes_cli.subcommands.approvals import build_approvals_parser
