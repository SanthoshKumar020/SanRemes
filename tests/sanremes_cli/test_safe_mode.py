"""Tests for `sanremes chat --safe-mode` isolation."""
...
_VARS = ("SANREMES_SAFE_MODE", "SANREMES_IGNORE_USER_CONFIG", "SANREMES_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SANREMES_SAFE_MODE"] == "1"
        assert os.environ["SANREMES_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SANREMES_IGNORE_RULES"] == "1"
        return True
