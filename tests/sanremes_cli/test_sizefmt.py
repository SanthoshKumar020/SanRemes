"""Tests for the shared byte formatter (sanremes_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from sanremes_cli.backup import _format_size as backup
    from sanremes_cli.checkpoints import _fmt_bytes as checkpoints
    from sanremes_cli.doctor import _human_bytes as doctor
