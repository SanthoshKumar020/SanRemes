...
class TestXiaomiCredentials:
    ...
    def test_resolve_credentials_reads_home_external_secret_scope(
        ...
        from sanremes_cli import env_loader
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in SANREMES_OVERLAYS
        overlay = SANREMES_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify sanremes doctor recognizes Xiaomi env vars."""
