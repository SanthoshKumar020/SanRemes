"""Tests for `sanremes curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated SANREMES_HOME with real agent-created skills on disk."""
    ...
    from sanremes_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import sanremes_cli.curator as curator_cli
