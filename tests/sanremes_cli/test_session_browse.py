"""Tests for the interactive session browser (`sanremes sessions browse`).
...
from sanremes_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """sanremes sessions browse should be parseable."""
