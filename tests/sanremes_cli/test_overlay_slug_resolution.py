...
SANREMES_OVERLAYS keys may be models.dev IDs (e.g. "github-copilot") while
_PROVIDER_MODELS and config.yaml use SanRemes IDs ("copilot").  The slug
...
def test_copilot_uses_sanremes_slug():
...
def test_mapped_provider_credential_pool_visibility(monkeypatch):
    ...
    monkeypatch.setattr(
        "sanremes_cli.auth._load_auth_store",
