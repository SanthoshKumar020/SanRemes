...
import sanremes_cli.macos_tcc_anchor as tcc
from sanremes_constants import venv_python_path
...
class TestUvStoreDetection:
    ...
    def test_matches_sanremes_runtime_repair_generation(self):
        path = (
            "/Users/u/sanremes-agent/.sanremes-runtime/python/"
...
class TestEnsureTccAnchor:
    ...
    def test_store_root_marker_tracks_managed_uv_constant(self):
        ...
        from sanremes_cli.managed_uv import _RUNTIME_DIR_NAME
