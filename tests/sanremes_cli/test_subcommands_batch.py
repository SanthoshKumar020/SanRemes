...
from sanremes_cli.subcommands.auth import build_auth_parser
from sanremes_cli.subcommands.backup import build_backup_parser
from sanremes_cli.subcommands.config import build_config_parser
from sanremes_cli.subcommands.dashboard import build_dashboard_parser
from sanremes_cli.subcommands.debug import build_debug_parser
from sanremes_cli.subcommands.doctor import build_doctor_parser
from sanremes_cli.subcommands.dump import build_dump_parser
from sanremes_cli.subcommands.gui import build_gui_parser
from sanremes_cli.subcommands.hooks import build_hooks_parser
from sanremes_cli.subcommands.import_cmd import build_import_cmd_parser
from sanremes_cli.subcommands.login import build_login_parser
from sanremes_cli.subcommands.logout import build_logout_parser
from sanremes_cli.subcommands.logs import build_logs_parser
from sanremes_cli.subcommands.model import build_model_parser

from sanremes_cli.subcommands.prompt_size import build_prompt_size_parser
from sanremes_cli.subcommands.security import build_security_parser
from sanremes_cli.subcommands.setup import build_setup_parser
from sanremes_cli.subcommands.slack import build_slack_parser
from sanremes_cli.subcommands.status import build_status_parser
...
from sanremes_cli.subcommands.webhook import build_webhook_parser
from sanremes_cli.subcommands.whatsapp import build_whatsapp_parser
...
def test_config_get_unset_subcommands_parse():
    """`sanremes config get/unset` parse key args (and --json for get)."""
    parser = argparse.ArgumentParser(prog="sanremes")
...
# ── deprecated `sanremes login` fails gracefully, not with argparse error ────
#
# `sanremes login` is a removed command; its handler (`login_command` in
# `sanremes_cli/auth.py`) prints a deprecation notice pointing at `sanremes auth` /
# `sanremes model` and exits 0.  Two behavior contracts guard the UX:
...
def test_login_subparser_help_is_suppressed():
    """The deprecated `login` row must not appear in `sanremes --help`.
