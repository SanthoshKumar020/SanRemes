"""Tests for `sanremes checkpoints prune`'s orphan confirmation flow.
...
_PRE_V2_ONLY_STATUS = {
    "projects": [],
    "pre_v2_projects": [
        {"path": "/home/user/.sanremes/checkpoints/deadbeefcafebabe", "workdir": None, "exists": False},
    ],
}
...
_MIXED_STATUS = {
    ...
    "pre_v2_projects": [
        {"path": "/home/user/.sanremes/checkpoints/deadbeefcafebabe", "workdir": "/gone/pre-v2-project", "exists": False},
    ],
}
