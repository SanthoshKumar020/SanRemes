...
from sanremes_cli import session_recovery
from sanremes_cli.session_lost_and_found import (
    classify_lost_and_found_row,
    map_lost_and_found_rows,
    rebuild_fts_indexes,
    stub_missing_parent_sessions,
)
from sanremes_cli.session_recovery import (
...
from tests.sanremes_cli.test_session_recovery import (
    _btree_leaf_pages,
    _make_page_spanning_source,
)


from sanremes_cli.session_lost_and_found import find_sqlite3_cli
...
def test_unreadable_schema_without_cli_names_the_sqlite3_requirement(
    ...
    import sanremes_cli.session_lost_and_found as laf
...
def test_fingerprint_error_enumerates_parent_cli_session(
    ...
    message = str(excinfo.value)
    assert "Stop every SanRemes process" in message
