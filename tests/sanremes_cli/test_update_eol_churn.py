"""Regression: ``sanremes update`` should take a managed checkout off autocrlf=true.
...
``sanremes update`` has to repair them.
...
from sanremes_cli.update_cmd import _normalize_managed_eol
