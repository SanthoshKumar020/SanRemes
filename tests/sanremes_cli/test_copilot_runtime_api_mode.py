...
def test_copilot_runtime_api_mode_uses_target_model_over_stale_config_default(monkeypatch):
    ...
    monkeypatch.setattr(
        "sanremes_cli.models.copilot_model_api_mode",
...
@pytest.mark.parametrize("credential_source", ["pool", "explicit", "env", "sanremes-auth-store"])
...
def test_resolver_routes_copilot_by_target_model_for_every_credential_path(
    ...
    from sanremes_cli import models
    from sanremes_cli import runtime_provider as rp
