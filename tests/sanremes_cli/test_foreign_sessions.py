"""Tests for sanremes_cli.foreign_sessions — Claude Code / Codex CLI import.

Fixture JSONL is synthesized inline (tmp_path); the SessionDB is opened
against a temp path so nothing touches the real SANREMES_HOME store.
"""
...
from sanremes_cli.foreign_sessions import (
