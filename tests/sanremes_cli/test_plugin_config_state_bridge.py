...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\SanRemes 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\SanRemes 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\SanRemes 🚀"
...
"""
    env = dict(os.environ, SANREMES_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
