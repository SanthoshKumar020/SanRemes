...
class TestStatusEndpointTopology:
    ...
    def _setup_client(self, monkeypatch, _isolate_sanremes_home):
        try:
    ...
    def test_profile_names_and_mode_public_when_auth_gated(self, monkeypatch):
        ...
        # SanRemes Cloud Portal reads /api/status over the network (a gated bind)
        ...
        try:
            ...
            # alongside sanremes_home / gateway_pid.
            assert "gateways" not in data
            assert "sanremes_home" not in data
