...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`sanremes_cli.slash_exec.EXECUTORS`, and
...
from sanremes_cli.commands import COMMAND_REGISTRY, resolve_command
from sanremes_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
