...
The main() function in sanremes_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `sanremes -c model`
...
def _build_parser():
    """Build a minimal replica of the sanremes top-level parser."""
