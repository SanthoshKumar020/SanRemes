...
The canonical profile id ("default" for ~/.sanremes) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and SANREMES_HOME under tmp_path."""
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "sanremes_cli.profiles.check_alias_collision", lambda name: "skip"
        )
