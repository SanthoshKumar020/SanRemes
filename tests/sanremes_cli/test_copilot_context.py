...
class TestGetCopilotModelContext:
    ...
    @patch("sanremes_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("sanremes_cli.models._urlopen_model_catalog_request")
    ...
    @patch("sanremes_cli.models.fetch_github_model_catalog", return_value=[])
