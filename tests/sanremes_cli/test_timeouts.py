...
def test_resolved_api_call_timeout_priority(monkeypatch, tmp_path):
          ...
          openrouter:
            ...
            models:
              openai/gpt-4o-mini:
                timeout_seconds: 42
        """)
    monkeypatch.setenv("SANREMES_API_TIMEOUT", "999")
    ...
    from sanremes_cli import timeouts as to_mod
    ...
    monkeypatch.delenv("SANREMES_API_TIMEOUT", raising=False)
