"""Unit tests for sanremes_cli.managed_scope (resolver + loaders + key helpers)."""
import textwrap
...
def test_managed_dir_env_scrubbed_by_default():
    """conftest must scrub SANREMES_MANAGED_DIR so a dev-shell value can't leak in."""
    import os

    assert "SANREMES_MANAGED_DIR" not in os.environ
