...
import pytest
from sanremes_cli.config import _expand_env_vars, load_config
...
class TestLoadConfigExpansion:
    def test_load_config_expands_env_vars(self, tmp_path, monkeypatch):
        ...
        # sanremes_cli.config, making string-target monkeypatches hit a different
...
class TestLoadConfigCacheEnvStaleness:
    ...
    environment (#58514): a load before load_sanremes_dotenv() runs, or an env
