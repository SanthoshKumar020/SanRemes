...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (SANREMES_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via SANREMES_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in SANREMES_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from sanremes_cli.providers import SANREMES_OVERLAYS
        assert "bedrock" in SANREMES_OVERLAYS
