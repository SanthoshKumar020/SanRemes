"""Tests for `sanremes secrets bitwarden token` / `sanremes secrets onepassword token`.
...
from sanremes_cli import onepassword_secrets_cli as op_cli
from sanremes_cli import secrets_cli as bw_cli
