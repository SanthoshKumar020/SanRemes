"""Tests for the specifier module + `sanremes kanban specify` CLI surface.
...
from sanremes_cli import kanban as kanban_cli
from sanremes_cli import kanban_db as kb
from sanremes_cli import kanban_specify as spec
...
def _run_cli(*argv: str) -> int:
    """Invoke the `sanremes kanban …` argparse surface directly."""
