...
Profile-aware location: ``$SANREMES_HOME/logs/dashboard-auth.log``.
...
from sanremes_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $SANREMES_HOME and ~ to a tmp dir for the duration of the test."""
