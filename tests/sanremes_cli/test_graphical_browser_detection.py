"""Tests for `_can_open_graphical_browser()` in sanremes_cli.auth.

Guards the fix for the May 2026 report where `sanremes auth add xai-oauth`
...
from sanremes_cli.auth import _can_open_graphical_browser
