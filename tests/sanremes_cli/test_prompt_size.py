"""Tests for the ``sanremes prompt-size`` diagnostic (issue #34667)."""
...
from sanremes_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(sanremes_home, memory_text="", user_text=""):
    mem_dir = sanremes_home / "memories"
...
def _seed_skill(sanremes_home, name, description):
    skill_dir = sanremes_home / "skills" / "demo" / name
