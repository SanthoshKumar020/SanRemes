...
def _patch_sessiondb(monkeypatch):
    ...
    monkeypatch.setattr(sanremes_state, "SessionDB", _RecordingDB)
...
def test_loop_thread_cache_hit_returns_cached_instance(monkeypatch):
    ...
    goals._DB_CACHE[str(get_sanremes_home())] = sentinel
    result = "UNSET"
...
def test_slow_construction_does_not_block_the_loop(monkeypatch):
    ...
    monkeypatch.setattr(sanremes_state, "SessionDB", _BlockingDB)
    elapsed = None
    elapsed2 = None
    result = "UNSET"
    result2 = "UNSET"
