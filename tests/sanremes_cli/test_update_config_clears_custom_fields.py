"""Tests for sanremes_cli.auth._update_config_for_provider clearing stale fields.
...
from sanremes_cli.config import clear_model_endpoint_credentials, get_config_path
