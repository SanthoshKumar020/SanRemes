...
The oneshot path builds its AIAgent directly (bypassing SanRemesCLI), so the
...
from sanremes_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
