"""Session <-> workspace grouping key (sanremes_state.workspace_key).

The key is what `sanremes sessions list --workspace` groups/filters on. It is a
...
from sanremes_state import workspace_key
