"""Regression test: sanremes update must not load cryptography eagerly."""
...
assert 'sanremes_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running sanremes update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so sanremes_cli is importable,
...
import sanremes_cli.main
from sanremes_cli.update_cmd import _cmd_update_check
