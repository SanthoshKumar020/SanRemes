...
def server(sanremes_home):
    ...
    # and re-captures module-level paths like _sanremes_home against this
...
@pytest.fixture()
def db(sanremes_home):
    return SessionDB(db_path=sanremes_home / "state.db")
