...
between ``SANREMES_BACKEND_READY`` and the first prompt. Three fixes:
...
class TestCopilotAuthSkipsGhCli:
    ...
    def test_no_env_vars_falls_back_to_gh_cli(self, monkeypatch):
        ...
        with patch(
            "sanremes_cli.copilot_auth._try_gh_cli_token",
...
def test_warm_gateway_module_imports_cold_start_chains():
    ...
    import sanremes_cli.web_server as web_server_mod

    required = {
        "sanremes_cli.gateway",
        "sanremes_cli.auth",
        "sanremes_cli.copilot_auth",
        "sanremes_cli.runtime_provider",
        "sanremes_cli.skin_engine",
        "sanremes_cli.inventory",
        "sanremes_cli.model_switch",
    }
