...
The unit tests in tests/sanremes_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned sanremes-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/sanremes")
from sanremes_cli.service_manager import S6ServiceManager
