...
_CA_ENV_VARS = ("SANREMES_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "HTTPS_PROXY")
...
def test_build_keepalive_http_client_uses_sanremes_ca_bundle(clean_tls_env, monkeypatch):
    monkeypatch.setenv("SANREMES_CA_BUNDLE", certifi.where())
