...
def store(tmp_path, monkeypatch):
    ...
    ~/.sanremes/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at sanremes_state import time, before pytest's SANREMES_HOME monkeypatch
    fires — the autouse fixture's SANREMES_HOME override doesn't help here.)
    """
