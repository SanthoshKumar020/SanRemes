...
def _make_adapter(
    ...
    *,
    ...
    monkeypatch.setenv("SANREMES_DISCORD_LIVENESS_INTERVAL_SECONDS", str(interval))
    monkeypatch.setenv("SANREMES_DISCORD_LIVENESS_FAILURE_THRESHOLD", str(threshold))
...
def test_platform_config_extra_overrides_process_liveness_bridge(monkeypatch):
    monkeypatch.setenv("SANREMES_DISCORD_LIVENESS_INTERVAL_SECONDS", "99")
    monkeypatch.setenv("SANREMES_DISCORD_LIVENESS_FAILURE_THRESHOLD", "9")
