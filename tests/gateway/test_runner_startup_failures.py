...
async def test_start_gateway_verbosity_imports_redacting_formatter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("sanremes_logging.setup_logging", lambda sanremes_home, mode: tmp_path)
    monkeypatch.setattr("sanremes_logging._add_rotating_handler", lambda *args, **kwargs: None)
