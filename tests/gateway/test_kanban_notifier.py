...
def test_review_requested_wakes_the_origin_session(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SANREMES_KANBAN_DB", str(tmp_path / "review-wake.db"))
    kb.init_db()
...
def test_block_loop_detected_wakes_the_origin_session(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("SANREMES_KANBAN_DB", str(tmp_path / "triage-wake.db"))
    kb.init_db()
...
def test_review_requested_does_not_wake_a_notify_only_subscription(
    ...
    monkeypatch.setenv("SANREMES_KANBAN_DB", str(tmp_path / "review-notify.db"))
    kb.init_db()
