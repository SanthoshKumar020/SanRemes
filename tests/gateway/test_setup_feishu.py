"""Tests for _setup_feishu() in sanremes_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("sanremes_cli.config.save_env_value", side_effect=mock_save), \
         patch("sanremes_cli.config.get_env_value", side_effect=mock_get), \
         patch("sanremes_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("sanremes_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("sanremes_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("sanremes_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("sanremes_cli.cli_output.print_header"), \
         patch("sanremes_cli.cli_output.print_info"), \
         patch("sanremes_cli.cli_output.print_success"), \
         patch("sanremes_cli.cli_output.print_warning"), \
         patch("sanremes_cli.cli_output.print_error"), \
