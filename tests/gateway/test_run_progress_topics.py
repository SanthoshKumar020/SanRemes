...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.sanremes/sanremes-agent/.worktrees/sanremes-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
class UrlPreviewAgent:
    URL = "https://sanremes-agent.nousresearch.com/docs/gateway/discord/tool-progress"
...
async def test_run_agent_progress_uses_event_message_id_for_slack_dm(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("SANREMES_TOOL_PROGRESS_MODE", "all")
...
async def test_terminal_progress_verbose_shows_full_command(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("SANREMES_TOOL_PROGRESS_MODE", "verbose")
