...
stale-module ImportError after ``sanremes update``.
"""
...
class TestModelSwitchSkewGuard:
    ...
    def test_guard_message_names_revs_and_restart(self, monkeypatch):
        ...
        assert "sanremes gateway restart" in msg
...
class TestModelOptionsSkewGuard:
    ...
    Regression for #86207: a dashboard kept alive across ``sanremes update``
    ...
    def test_stale_dashboard_returns_503_and_skips_payload_build(self, monkeypatch):
        ...
        payload_calls: list = []
        monkeypatch.setattr(
            "sanremes_cli.inventory.build_model_options_payload",
    ...
    def test_fresh_dashboard_builds_payload_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr("sanremes_cli.inventory.load_picker_context", lambda: {})
