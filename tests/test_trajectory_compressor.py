...
def test_import_loads_env_from_sanremes_home(tmp_path, monkeypatch):
    home = tmp_path / ".sanremes"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-sanremes-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-sanremes-home"
