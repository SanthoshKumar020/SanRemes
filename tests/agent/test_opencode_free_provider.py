...
header (see sanremes_cli.models.opencode_zen_free_runtime).
"""
...
class TestOpenCodeFreeModelLists:
    ...
    def test_fallback_models_exist(self):
        from sanremes_cli.setup import _DEFAULT_PROVIDER_MODELS
    ...
    def test_every_curated_model_is_keyless(self):
        ...
        from sanremes_cli.models import _PROVIDER_MODELS, is_opencode_zen_free_model
...
class TestOpenCodeFreeRuntimeKeyless:
    ...
    def test_free_provider_muse_routes_responses(self):
        ...
        from sanremes_cli.models import opencode_zen_free_runtime
