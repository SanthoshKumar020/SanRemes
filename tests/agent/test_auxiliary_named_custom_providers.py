...
def _isolate(tmp_path, monkeypatch):
    """Redirect SANREMES_HOME and clear module caches."""
...
def _write_config(tmp_path, config_dict):
    """Write a config.yaml to the test SANREMES_HOME."""
    import yaml
...
class TestResolveProviderClientMainAlias:
    ...
    def test_main_resolves_github_copilot_alias(self, tmp_path):
        ...
        with (
            patch("sanremes_cli.auth.resolve_api_key_provider_credentials", return_value={
