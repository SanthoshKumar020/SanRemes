...
manipulation. SanRemes keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point SANREMES_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_sanremes_home /
    get_default_sanremes_root) instead of monkeypatching private helpers —
    ...
    SANREMES_HOME=<root>/profiles/<name> makes get_default_sanremes_root()
