...
* ``sanremes_cli._subprocess_compat.kill_process_tree(proc)`` — also consumed
...
# ---------------------------------------------------------------------------
# (1) sanremes_cli._subprocess_compat.kill_process_tree
# ---------------------------------------------------------------------------

class TestSubprocessCompatDelegation:
    def test_delegates_with_proc_pid(self, monkeypatch):
        from sanremes_cli import _subprocess_compat
...
def test_e2e_setsid_grandchild_killed_via_compat_wrapper(tmp_path):
    ...
    from sanremes_cli._subprocess_compat import kill_process_tree
