...
Damien's incident (Discord, 2026-05-28): a long SanRemes session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``sanremes_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "sanremes_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "sanremes_state"
