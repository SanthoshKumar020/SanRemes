...
Reports live under ``~/.sanremes/logs/curator/{YYYYMMDD-HHMMSS}/`` alongside
...
def curator_env(tmp_path, monkeypatch):
    """Isolated SANREMES_HOME with a skills/ dir + reset curator module state."""
...
def curator_env_with_cron(curator_env, monkeypatch):
    ...
    monkeypatch.setattr(jobs_mod, "SANREMES_DIR", home)
