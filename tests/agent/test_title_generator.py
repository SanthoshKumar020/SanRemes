...
class TestGenerateTitle:
    ...
    def test_title_language_reads_config(self):
        ...
        with patch("sanremes_cli.config.load_config", side_effect=RuntimeError("bad config")), \
         patch("sanremes_cli.config.load_config_readonly", side_effect=RuntimeError("bad config")):
            assert _title_language() == ""
