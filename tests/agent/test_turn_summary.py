...
def _make_cli(**overrides):
    ...
    Avoids constructing SanRemesCLI (which loads config, sessions, and a
    ...
    class _Stub:
        ...
        _turn_summary_is_active = cli_module.SanRemesCLI._turn_summary_is_active
        _turn_summary_begin = cli_module.SanRemesCLI._turn_summary_begin
        _turn_summary_record = cli_module.SanRemesCLI._turn_summary_record
        _turn_summary_emit = cli_module.SanRemesCLI._turn_summary_emit
        _spinner_token_flow = cli_module.SanRemesCLI._spinner_token_flow
        _render_spinner_text = cli_module.SanRemesCLI._render_spinner_text
