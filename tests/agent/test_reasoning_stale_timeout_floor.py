...
thinking phase.  SanRemes's default cloud-stream stale detector
(``SANREMES_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SANREMES_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
