"""Tests for the sanremes-tools-as-MCP server module surface.
...
from agent.transports.sanremes_tools_mcp_server import (
...
class TestModuleSurface:
    def test_module_imports_clean(self):
        from agent.transports import sanremes_tools_mcp_server as m
...
class TestMain:
    def test_main_returns_2_when_mcp_unavailable(self, monkeypatch):
        ...
        import agent.transports.sanremes_tools_mcp_server as m
