...
from sanremes_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_credits_command_fully_removed():
    ...
    from sanremes_cli.commands import resolve_command, COMMAND_REGISTRY
