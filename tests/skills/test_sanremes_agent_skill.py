"""The `sanremes-agent` skill is what a running SanRemes knows about itself.

`website/` is never packaged, so an installed SanRemes has no local copy of the
user guide; skills ARE synced into `$SANREMES_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "SanRemes can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "sanremes-agent"
