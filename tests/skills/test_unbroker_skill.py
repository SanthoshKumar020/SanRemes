...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and sanremes-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # sanremes-agent (tests/skills/)
]
