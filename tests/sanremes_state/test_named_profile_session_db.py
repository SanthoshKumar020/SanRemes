...
#88532 made SessionStore follow SANREMES_HOME; this covers the TUI/agent
...
def homes(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(sanremes_state, "DEFAULT_DB_PATH", sanremes_state._IMPORT_DEFAULT_DB_PATH)
    return root, profile
...
def test_open_profile_session_db_does_not_fallback_on_open_failure(homes, monkeypatch):
    ...
    monkeypatch.setattr("sanremes_state.SessionDB", boom_db)
