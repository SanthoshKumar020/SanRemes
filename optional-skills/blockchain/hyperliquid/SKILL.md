...
```bash
python ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
