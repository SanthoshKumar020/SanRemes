...
Data file: $SANREMES_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SANREMES_HOME = Path(os.environ.get("SANREMES_HOME", Path.home() / ".sanremes"))
DATA_DIR = _SANREMES_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
