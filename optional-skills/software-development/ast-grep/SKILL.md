...
version: 1.0.0
author: Yeongyu Kim (code-yeongyu), adapted by SanRemes Agent
license: MIT
...
- This complements (does not replace) SanRemes's `patch` tool: `patch` is for targeted edits you author; ast-grep is for pattern-driven bulk rewrites across many sites.
