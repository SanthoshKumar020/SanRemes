...
def _state_dir() -> Path:
    ...
    # Default: $SANREMES_HOME/watcher-state/, falling back to ~/.sanremes/watcher-state/.
    sanremes_home = os.environ.get("SANREMES_HOME") or str(Path.home() / ".sanremes")
    return Path(sanremes_home) / "watcher-state"
