...
DEFAULT_UA = (
    "sanremes-osint-investigation/0.2 "
    "(+https://github.com/NousResearch/sanremes-agent; "
    "set SANREMES_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("SANREMES_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
