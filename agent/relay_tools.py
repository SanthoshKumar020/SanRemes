"""Core NeMo Relay adapter for SanRemes tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the SanRemes tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous SanRemes Relay tool execution cannot run on an active event-loop thread"
    )
