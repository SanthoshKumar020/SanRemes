...
# ``data:`` field before SanRemes receives a completion chunk.  Keeping this
...
# See: https://github.com/NousResearch/sanremes-agent/issues/69078
...
#
# See: https://github.com/NousResearch/sanremes-agent/issues/27344
...
# case: a stream dies mid-response and SanRemes persists a content-less
...
# Request parameters that SanRemes sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # sanremes_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from sanremes_cli.plugins import get_plugin_error_classification
