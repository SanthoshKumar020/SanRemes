...
_SESSION_CWD: ContextVar = ContextVar("SANREMES_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the SanRemes
    # source tree itself, which is a legitimate workspace when the user is
    # developing SanRemes (per-surface policy for fallback-picked directories
