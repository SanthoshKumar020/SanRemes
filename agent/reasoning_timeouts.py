...
first content token) routinely exceed SanRemes's default chat-model
stale detectors:

* Stream stale detector:   ``SANREMES_STREAM_STALE_TIMEOUT``     default 180s
                           ``agent/chat_completion_helpers.py:2544``
* Non-stream stale detector: ``SANREMES_API_CALL_STALE_TIMEOUT``  default 90s
                           ``run_agent.py:1140``
