...
(3 SDK retries x 3 SanRemes retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_sanremes_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".sanremes")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, SanRemes, ...) behind one endpoint.  A 429 can mean either:
