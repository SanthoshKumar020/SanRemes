...
class LSPService:
    ...
    def create_from_config(cls) -> Optional["LSPService"]:
        """Build a service from ``sanremes_cli.config`` settings.
    ...
    def enabled_for(self, file_path: str) -> bool:
        ...
        timeout cost — until the service is restarted (``sanremes lsp
    ...
    # ------------------------------------------------------------------
    # status / introspection (used by ``sanremes lsp status``)
    # ------------------------------------------------------------------
