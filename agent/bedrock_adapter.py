"""AWS Bedrock Converse API adapter for SanRemes Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install SanRemes with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When SanRemes is installed editable into system Python, the system boto3
