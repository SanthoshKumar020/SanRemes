  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the SanRemes Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use SanRemes &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with SanRemes?{' '}
        <a
          href="https://github.com/NousResearch/sanremes-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
