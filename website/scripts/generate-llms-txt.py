#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the SanRemes docs site.
...
LLM reads to learn what SanRemes does.

Both publish at:
  https://sanremes-agent.nousresearch.com/docs/llms.txt
  https://sanremes-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://sanremes-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use SanRemes as a Python Library", None),
        ("guides/use-mcp-with-sanremes", "Use MCP with SanRemes", None),
        ("guides/use-voice-mode-with-sanremes", "Use Voice Mode with SanRemes", None),
        ("guides/use-soul-with-sanremes", "Use SOUL.md with SanRemes", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with SanRemes"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "sanremes-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/sanremes-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# SanRemes Agent — Full Documentation\n",
        (
            "This file is the entire SanRemes Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using SanRemes, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://sanremes-agent.nousresearch.com/docs\n",
        "Short index: https://sanremes-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
