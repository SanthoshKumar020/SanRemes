...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `sanremes_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `sanremes_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a SanRemes Plugin](plugins/index.md) |
...
| Session storage | `sanremes_state.py` | [Session Storage](session-storage.md) |
