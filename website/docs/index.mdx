...
slug: /
sidebar_position: 0
title: "SanRemes Agent Documentation"
...
After installing, run `sanremes setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::

## What is SanRemes Agent?
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend SanRemes safely  |
| 🧭 **[Use MCP with SanRemes](/guides/use-mcp-with-sanremes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with SanRemes](/guides/use-voice-mode-with-sanremes)** | Hands-on setup and usage patterns for SanRemes voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define SanRemes' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of SanRemes                              |
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind SanRemes, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind SanRemes, Nomos, and Psyche models
