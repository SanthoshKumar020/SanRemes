...
description: "How the SanRemes Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the SanRemes Desktop app connects to a **gated gateway** (a hosted or
...
For SanRemes specifically, native sign-in means:
...
- [Run SanRemes with Nous Portal](./run-sanremes-with-nous-portal.md)
