---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in SanRemes Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in SanRemes Agent"
---

# Run Nemotron 3 Ultra free in SanRemes Agent

Nous Research has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Nous Portal](https://portal.nousresearch.com) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your SanRemes Agent today.
...
[Download the SanRemes Desktop installer](https://sanremes-agent.nousresearch.com/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize SanRemes. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://sanremes-agent.nousresearch.com/install.sh), inspect it, then run it.
...
Select **Quick Setup**. SanRemes opens a browser tab and waits for you to finish the next steps.
...
When prompted to connect your account to SanRemes Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `sanremes portal info` confirms you're logged in and routing through Nous.
...
- **[Run SanRemes Agent with Nous Portal](/guides/run-sanremes-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
