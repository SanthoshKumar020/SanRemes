---
sidebar_position: 8
title: "Use Voice Mode with SanRemes"
description: "A practical guide to setting up and using SanRemes voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with SanRemes
...
- you want SanRemes sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in SanRemes.
...
## Step 1: make sure normal SanRemes works first
...
SanRemes supports both local and cloud speech stacks.
...
4. SanRemes transcribes and responds
...
- asking SanRemes to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full SanRemes loop.

## Tuning CLI behavior

### Silence threshold

If SanRemes starts/stops too aggressively, tune:
...
SanRemes stays a normal chat bot, but can speak replies.
...
- you want SanRemes to function like a portable research or ops assistant
...
SanRemes joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- SanRemes detects speech boundaries
- transcripts are posted in the associated text channel
- SanRemes responds in text and audio
...
1. get text SanRemes working
2. run `sanremes setup tts` to enable voice support
