...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`sanremes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sanremes-agent) |
...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the SanRemes terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For SanRemes itself, `model.provider: openai-codex` uses SanRemes-managed Codex
OAuth from `~/.sanremes/auth.json` after `sanremes auth add openai-codex`. For the
...
## SanRemes Gateway Caveat

When invoking the Codex CLI from a SanRemes gateway/service context (for example,
