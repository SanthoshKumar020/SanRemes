...
```bash
python3 -m pyfiglet "SANREMES" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SANREMES&font=Slant" | boxes -d stone
```
