...
| Version | `1.0.1` |
| Author | SanRemes Agent (adapted from gsd-build/get-shit-done) |
| License | MIT |
...
**Verify variants visually — use SanRemes' browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
