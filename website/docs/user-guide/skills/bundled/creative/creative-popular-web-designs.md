...
| Version | `1.0.0` |
| Author | SanRemes Agent + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
Each template includes a **SanRemes Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's SanRemes notes -->
