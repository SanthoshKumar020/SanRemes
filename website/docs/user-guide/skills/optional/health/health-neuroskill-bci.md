...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/health/neuroskill-bci` |
...
Connect SanRemes to a running [NeuroSkill](https://neuroskill.com/) instance to read
