...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | SanRemes Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SANREMES_OSINT_CACHE/icij/ (default: ~/.cache/sanremes-osint/icij/).
...
# Set SANREMES_OSINT_UA=your-app/1.0 (your@email) to identify yourself
