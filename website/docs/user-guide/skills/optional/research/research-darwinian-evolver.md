...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), SanRemes Agent |
| License | MIT |
...
import upstream classes into SanRemes itself.
...
```bash
mkdir -p ~/.sanremes/cache/darwinian-evolver && cd ~/.sanremes/cache/darwinian-evolver
...
```bash
cd ~/.sanremes/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.sanremes/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.sanremes/skills/research/darwinian-evolver
DE_DIR=~/.sanremes/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside SanRemes core.
   Custom driver scripts under `~/.sanremes/skills/...` are user-side and fine.
