...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`sanremes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sanremes-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
SanRemes Agent via the native MCP client. This is the preferred
...
Then configure SanRemes Agent to connect via HTTP:
