...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/research/gitnexus-explorer` |
...
| Related skills | [`sanremes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sanremes-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  sanremes-agent users don't need.
