...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/web-development/page-agent` |
...
- User wants **SanRemes itself to drive a browser** → use SanRemes' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
