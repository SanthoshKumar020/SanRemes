...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | SanRemes Agent (adapted from obra/superpowers) |
| License | MIT |
