...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/productivity/shopify` |
...
4. Save to `${SANREMES_HOME:-~/.sanremes}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"SanRemes","productType":"Apparel","tags":["test"]}}'
```
