...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), SanRemes Agent |
| License | MIT |
...
The script reads `${SANREMES_HOME:-~/.sanremes}/.env` for two optional defaults:
...
Helper script: `~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SANREMES_HOME:-~/.sanremes}/.env`.
...
```bash
python3 ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.sanremes/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
