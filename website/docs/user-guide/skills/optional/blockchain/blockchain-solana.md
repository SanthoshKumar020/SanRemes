...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/blockchain/solana` |
| Path | `optional-skills/blockchain/solana` |
| Version | `0.2.0` |
| Author | Deniz Alagoz (gizdusum), enhanced by SanRemes Agent |
| License | MIT |
...
Helper script path: ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py
...
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py price BONK
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py price JUP
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py price SOL
python3 ~/.sanremes/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
