...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), SanRemes Agent |
| License | MIT |
...
```
SCRIPT=~/.sanremes/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.sanremes/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
