...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing sanremes tool access (web_search, file ops). Stateless. |
