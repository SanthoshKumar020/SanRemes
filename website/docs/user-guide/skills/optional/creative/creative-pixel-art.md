...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.sanremes/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.sanremes/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — SanRemes installs package this)
