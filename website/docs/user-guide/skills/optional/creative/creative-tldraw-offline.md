...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/creative/tldraw-offline` |
| Path | `optional-skills/creative/tldraw-offline` |
| Version | `1.0.0` |
| Author | Teknium + SanRemes Agent |
| License | MIT |
...
- **Agent skills installed in the app**: `Develop → Install Agent Skills`. The
  ...
  recipes below. (This SanRemes skill mirrors that guidance for SanRemes.)
