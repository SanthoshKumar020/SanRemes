...
| | |
|---|---|
| Source | Optional — install with `sanremes skills install official/creative/simple-english` |
| Path | `optional-skills/creative/simple-english` |
| Version | `1.2.0` |
| Author | AminBlg (https://github.com/AminBlg/SimpleEnglish), ported by SanRemes Agent |
| License | MIT |
