...
| [`sanremes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-sanremes-agent) | Use, configure, theme, extend, and orchestrate SanRemes Agent. | `autonomous-ai-agents/sanremes-agent` |
...
| [`sanremes-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-sanremes-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/sanremes-agent-skill-authoring` |
| [`inspecting-sanremes-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-sanremes-desktop-dom) | Read the live SanRemes desktop DOM/CSS over CDP. | `software-development/inspecting-sanremes-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .sanremes/plans/; no execution. | `software-development/plan` |
