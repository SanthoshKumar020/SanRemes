...
def resolve_profile(rid, params, err_fn) -> Tuple[Optional[Any], Optional[dict]]:
    """Resolve the optional ``profile`` param to a SANREMES_HOME override token.
    ...
    return set_sanremes_home_override(str(profile_dir)), None
...
def summarize_server(name: str, cfg: dict) -> Dict[str, Any]:
    ...
    """
    from sanremes_cli.mcp_config import _oauth_tokens_present
