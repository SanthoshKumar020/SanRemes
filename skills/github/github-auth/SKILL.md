...
uv run python "${SANREMES_HOME:-$HOME/.sanremes}/skills/github/github-auth/scripts/git-credential-token.py"
```
...
if command -v gh &>/dev/null && gh auth status &>/dev/null; then
  ...
  export GITHUB_TOKEN=$(uv run python "${SANREMES_HOME:-$HOME/.sanremes}/skills/github/github-auth/scripts/git-credential-token.py")
  echo "AUTH_METHOD=curl"
else
