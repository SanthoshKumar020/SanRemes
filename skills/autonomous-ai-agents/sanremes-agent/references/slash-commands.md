...
Registry of record: `sanremes_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore SanRemes config+state snapshots (CLI)
...
/update                  Update SanRemes to latest
