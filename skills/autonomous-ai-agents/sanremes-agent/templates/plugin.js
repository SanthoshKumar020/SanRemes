/**
 * SanRemes desktop plugin template. Save as:
 *   <sanremes home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <sanremes home> is ~/.sanremes by default, or ~/.sanremes/profiles/<name>
 * when running a named profile (`sanremes -p <name>`). Run `sanremes doctor` (or
 ...
 * Only these imports resolve: @sanremes/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@sanremes/plugin-sdk'
