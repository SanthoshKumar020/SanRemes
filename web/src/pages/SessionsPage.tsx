...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    sanremes_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__sanremes_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-SanRemes-Session-Token":
              (window as unknown as { __SANREMES_SESSION_TOKEN__?: string })
                .__SANREMES_SESSION_TOKEN__ ?? "",
          },
        });
