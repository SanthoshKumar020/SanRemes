...
export interface Translations {
  ...
  status: {
    ...
    updateSanRemesConfirmMessage?: string;
    updateSanRemesConfirmNow?: string;
    updateSanRemesConfirmTitle?: string;
    updatingSanRemes: string;
  ...
  // ── Achievements plugin (plugins/sanremes-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
