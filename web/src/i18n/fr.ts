...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateSanRemes: "Mettre à jour SanRemes",
    updatingSanRemes: "Mise à jour de SanRemes…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins SanRemes (parité avec `sanremes plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.sanremes/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.sanremes/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.sanremes/skills/",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que SanRemes ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges SanRemes à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions SanRemes en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez SanRemes davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'SanRemes détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "SanRemes analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
