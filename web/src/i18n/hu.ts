...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateSanRemes: "SanRemes frissítése",
    updatingSanRemes: "SanRemes frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "SanRemes-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `sanremes plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.sanremes/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.sanremes/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.sanremes/skills/ mappából töltődnek be",
  ...
  env: {
    ...
    customHint: "A .env fájlban tárolt tetszőleges környezeti változók, amelyeket a SanRemes nem ismer fel. Használd ezeket környezeti változók beillesztésére képességekhez, MCP-kiszolgálókhoz vagy saját eszközeidhez.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető SanRemes-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "SanRemes munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a SanRemest",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a SanRemes kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A SanRemes egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
