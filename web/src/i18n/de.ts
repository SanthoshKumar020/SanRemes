...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateSanRemes: "SanRemes aktualisieren",
    updatingSanRemes: "SanRemes wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "SanRemes-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `sanremes plugins`).",
    ...
    removeConfirm: "Dieses Plugin aus ~/.sanremes/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.sanremes/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.sanremes/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die SanRemes nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare SanRemes-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "SanRemes-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze SanRemes mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald SanRemes ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "SanRemes scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
