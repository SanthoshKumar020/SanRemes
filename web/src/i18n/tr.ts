...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateSanRemes: "SanRemes'i Güncelle",
    updatingSanRemes: "SanRemes güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "SanRemes eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`sanremes plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.sanremes/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.sanremes/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.sanremes/skills/ adresinden yüklenir",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve SanRemes'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk SanRemes rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "SanRemes oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "SanRemes'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. SanRemes ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "SanRemes yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
