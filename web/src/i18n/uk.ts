...
export const uk: Translations = {
  ...
  status: {
    ...
    stopped: "Зупинено",
    updateSanRemes: "Оновити SanRemes",
    updatingSanRemes: "Оновлення SanRemes…",
  ...
  pluginsPage: {
    ...
    headline:
      "Знаходьте, встановлюйте, вмикайте та оновлюйте плагіни SanRemes (паритет з `sanremes plugins`).",
    ...
    removeConfirm: "Видалити цей плагін з ~/.sanremes/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.sanremes/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.sanremes/skills/",
  ...
  env: {
    ...
    customHint: "Довільні змінні середовища, збережені у вашому .env, які SanRemes не розпізнає. Використовуйте їх для впровадження змінних середовища для навичок, серверів MCP або власних інструментів.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Колекційні значки SanRemes, отримані з реальної історії сеансів. Відомі, але ще не виконані досягнення показані як Виявлені; Секретні досягнення залишаються прихованими, доки не з'явиться перший відповідний сигнал.",
      scan_subtitle:
        "Сканування історії сеансів SanRemes. Перше сканування на великих історіях може тривати 5–10 секунд.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Останнє",
      latest_hint_empty: "запускайте SanRemes частіше",
      none_yet: "Поки немає",
    },
    state: {
      unlocked: "Розблоковано",
    ...
    guide: {
      ...
      secret_body:
        "Секрети приховують свій точний тригер. Щойно SanRemes побачить пов'язаний сигнал, картка стає Виявленою та показує свою умову.",
      scan_status_header: "Стан сканування",
      scan_status_body:
        "SanRemes одноразово сканує локальну історію, а потім картки з'являться автоматично. Якщо це триває кілька секунд — нічого не зависло.",
