...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateSanRemes: "Nuashonraigh SanRemes",
    updatingSanRemes: "Ag nuashonrú SanRemes…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins SanRemes (paireacht le `sanremes plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.sanremes/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.sanremes/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.sanremes/skills/",
  ...
  env: {
    ...
    customHint: "Athróga timpeallachta treallach atá stóráilte i do .env nach n-aithníonn SanRemes. Úsáid iad chun athróga timpeallachta a instealladh do scileanna, freastalaithe MCP, nó d'uirlisí féin.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais SanRemes inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session SanRemes á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith SanRemes níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann SanRemes comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann SanRemes an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
