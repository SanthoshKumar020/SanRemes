 ...
 * `window.__SANREMES_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the SanRemes brand in the top bar
 ...
 *  `window.__SANREMES_PLUGINS__.registerSlot(...)`.
 *
