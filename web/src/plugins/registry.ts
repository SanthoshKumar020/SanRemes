 ...
 *
 * Plugins call window.__SANREMES_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SANREMES_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SANREMES_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SANREMES_PLUGIN_SDK__ = {
    ...
    // window.__SANREMES_SESSION_TOKEN__ directly.
    authedFetch,
