/**
 * SanRemes Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SANREMES_PLUGIN_SDK__`` and
 * ``window.__SANREMES_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SANREMES_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SanRemesPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@sanremes/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SANREMES_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SANREMES_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SANREMES_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SanRemesPluginSDK {
...
declare global {
  interface Window {
    __SANREMES_PLUGIN_SDK__?: SanRemesPluginSDK;
    __SANREMES_PLUGINS__?: PluginRegistry;
  }
}
