...
const STORAGE_KEY = "sanremes-dashboard-theme";
...
const FONT_STORAGE_KEY = "sanremes-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `sanremes_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "sanremes-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-sanremes-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-sanremes-theme-font", "true");
