 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `sanremes_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "SanRemes Teal",
  description: "Classic dark teal — the canonical SanRemes look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "SanRemes Teal (Large)",
  description: "SanRemes Teal with bigger fonts and roomier spacing",
