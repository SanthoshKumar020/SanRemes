 ...
 *
 * Values mirror sanremes_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the SanRemes default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (SanRemes' default when unset). */
