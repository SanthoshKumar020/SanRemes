...
Only included in the sanremes-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "SanRemes-Agent (https://github.com/NousResearch/sanremes-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_sanremes_home() / "cache" / "discord_capabilities.json"
