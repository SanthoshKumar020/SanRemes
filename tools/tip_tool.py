#!/usr/bin/env python3
"""Point at something in the SanRemes desktop GUI and say one line about it.
...
SanRemes raises mid-conversation in answer to something the user said.
...
def tip_tool(text: str, selector: str, title: str = "", side: str = "") -> str:
    ...
    if not ok:
        return tool_error("tip is only available in the SanRemes desktop app.")
