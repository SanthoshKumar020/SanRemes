#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the SanRemes desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the SanRemes desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "SanRemes desktop GUI (the pane open_preview opens beside this chat). Call "
