#!/usr/bin/env python3
"""Run a guided tour (highlight + narrate UI elements) in the SanRemes desktop GUI.
...
- ``surface="app"`` — the SanRemes desktop app's own DOM (tours of SanRemes itself).
...
def tour_tool(
    ...
    if callback is None:
        return tool_error("tour is only available in the SanRemes desktop app.")
...
TOUR_SCHEMA = {
    ...
    "description": (
        ...
        "element, attach a titled popover. Surfaces: 'app' (SanRemes itself) "
