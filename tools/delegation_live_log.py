...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.sanremes)."""
    from sanremes_constants import get_sanremes_dir

    return get_sanremes_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== SanRemes subagent live transcript ===",
