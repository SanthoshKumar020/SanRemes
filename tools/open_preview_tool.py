#!/usr/bin/env python3
"""Open a URL, dev server, or file in the SanRemes desktop GUI's preview pane.
...
def open_preview_tool(url: str, label: str = "") -> str:
    ...
    if not ok:
        return tool_error("The preview pane is only available in the SanRemes desktop app.")
...
OPEN_PREVIEW_SCHEMA = {
    "name": "open_preview",
    "description": (
        "Open something in the preview pane beside the chat in the SanRemes desktop "
