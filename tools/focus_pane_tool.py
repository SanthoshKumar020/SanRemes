#!/usr/bin/env python3
"""Reveal/focus a pane in the SanRemes desktop GUI.
...
def focus_pane_tool(pane: str) -> str:
    ...
    if not ok:
        return tool_error("Pane focus is only available in the SanRemes desktop app.")
...
FOCUS_PANE_SCHEMA = {
    "name": "focus_pane",
    "description": (
        "Reveal and focus a SanRemes desktop pane when the user asks to see it: "
