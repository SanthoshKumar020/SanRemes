#!/usr/bin/env python3
"""Interact with the in-app browser / preview pane in the SanRemes desktop GUI.
...
def drive_preview_tool(
    ...
    if callback is None:
        return tool_error("drive_preview is only available in the SanRemes desktop app.")
