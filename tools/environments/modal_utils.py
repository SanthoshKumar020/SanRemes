"""Shared SanRemes-side execution flow for Modal transports.

This module deliberately stops at the SanRemes boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"SANREMES_EOF_{uuid.uuid4().hex[:8]}"
