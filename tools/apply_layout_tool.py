#!/usr/bin/env python3
"""Apply a layout preset in the SanRemes desktop GUI.
...
_TIMEOUT_NOTE = "Layout apply is only available in the SanRemes desktop app."
...
APPLY_LAYOUT_SCHEMA = {
    "name": "apply_layout",
    "description": (
        "Apply a saved layout preset to the SanRemes desktop app when the user "
