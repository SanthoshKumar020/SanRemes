...
`hey_sanremes.onnx` / `hey_sanremes.tflite` — the on-device "Hey SanRemes" hotword
...
- **Label:** the model registers as `hey_sanremes` (matches the filename).
