...
let
      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via SANREMES_BUNDLED_SKILLS /
            # SANREMES_OPTIONAL_SKILLS (see sanremes-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + SANREMES_BUNDLED_LOCALES
            # / SANREMES_OPTIONAL_MCPS, not via the wheel. Excluding them
  ...
  #
  # Usage:
  #   sanremesNpmLib.buildNpmPackage {
