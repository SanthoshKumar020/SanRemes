# nix/overlays.nix — Expose pkgs.sanremes-agent for external NixOS configs
#
...
# `pkgs.sanremes-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    sanremes-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
